...
def main():
    ...
    try:
        ...
        print(f"👥 Agents: {agents['total_agents']} registered, {agents['available_agents']} available")
...
- Multimedia & Content Specialist
        ...
        high_priority_id = mq_system.send_high_priority_message("agent_7", high_priority_content)
