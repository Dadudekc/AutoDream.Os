...
class TestDataRouter(unittest.TestCase):
    ...
    def test_routing_rules(self):
        ...
        router.add_routing_rule("high_priority_gaming", rule_conditions, rule_destinations)
    ...
    def test_default_destinations(self):
        ...
        entertainment_destinations = router._get_default_destinations(DataType.ENTERTAINMENT_CONTENT)
