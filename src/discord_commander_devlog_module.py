#!/usr/bin/env python3
"""
Discord Commander Devlog Module - Redirect to Unified System
===========================================================
...
from core.unified_discord_system import get_unified_discord, send_devlog

# Re-export for backward compatibility
__all__ = ['get_unified_discord', 'send_devlog']