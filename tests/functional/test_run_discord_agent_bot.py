...
try:
    from src.discord_commander.discord_agent_bot import DiscordAgentBot, DiscordAgentBotManager import
except ImportError:
    # If direct import fails, try from parent module"
    from discord_commander.discord_agent_bot import DiscordAgentBot, DiscordAgentBotManager import""
"""
""""
