...
class FSMCommunicationBridge:
    ...
    def __init__(self, fsm_core: FSMCoreV2, 
    ...
    def _initialize_bridge(self):
        ...
        try:
            ...
            self.communication_protocol.register_agent(
                ...
                capabilities=["fsm_coordination", "task_management", "agent_orchestration"],
            ...
            self.bridge_thread = threading.Thread(target=self._bridge_processing_loop, daemon=True)
    ...
    def _create_task_communication_channel(self, task_id: str, task):
        ...
        try:
            ...
            if task.assigned_agent:
                self._send_task_notification(task_id, task.assigned_agent, "task_assigned")
    ...
    def _send_task_notification(self, task_id: str, agent_id: str, notification_type: str):
    ...
    def _get_progress_indicators(self, task) -> Dict[str, Any]:
        ...
        try:
            indicators = {
                ...
                "evidence_count": len(task.evidence) if hasattr(task, 'evidence') else 0
            }
            return indicators
        except Exception as e:
    ...
    def _broadcast_task_event(self, event: FSMCommunicationEvent, event_type: str):
        ...
        try:
            ...
            if event_type == "task_created":
                ...
                recipients.extend([aid for aid in self.coordinated_agents if "coordinator" in aid.lower()])
            else:
    ...
    def _send_task_event_message(self, recipient: str, event: FSMCommunicationEvent, event_type: str):
    ...
    def _send_coordination_request(self, event: FSMCommunicationEvent):
        ...
        try:
            ...
            coordination_agents = [
                aid for aid in self.coordinated_agents
    ...
    def _trigger_dependent_tasks(self, completed_task_id: str):
        ...
        try:
            ...
            logger.info(f"Task {completed_task_id} completed, checking for dependent tasks")
