...
class FSMDiscordBridge:
    ...
    def create_task_via_discord(self, title: str, description: str, 
                               assigned_agent: str, priority: str = "normal",
                               channel: str = "tasks") -> str:
    ...
    def request_decision_via_discord(self, context: str, options: List[str],
        ...
        try:
            ...
            # Notify Discord
            self.discord_service.send_message(
                "fsm_bridge", "decision_result",
                f"🧠 Decision made: {result.selected_option}\nReasoning: {result.reasoning}",
                channel
            )
            
            return f"🧠 Decision: {result.selected_option}\nConfidence: {result.confidence}"
    ...
    # Command handlers
    def _handle_fsm_status_command(self, args: List[str], user_id: str, channel: str) -> str:
    ...
    def _handle_create_task_command(self, args: List[str], user_id: str, channel: str) -> str:
        ...
        return self.create_task_via_discord(title, description, agent, priority, channel)
    
    def _handle_update_task_command(self, args: List[str], user_id: str, channel: str) -> str:
    ...
    def _handle_agent_status_command(self, args: List[str], user_id: str, channel: str) -> str:
    ...
    def _handle_decision_request_command(self, args: List[str], user_id: str, channel: str) -> str:
    ...
    def _handle_sync_state_command(self, args: List[str], user_id: str, channel: str) -> str:
...
def main():
    ...
    if args.test:
        ...
        test_commands = [
            ...
            ("!create_task", ["Test Task", "Integration testing", "agent-1"], "test_user", "test_channel")
        ]
