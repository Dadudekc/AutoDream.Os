...
try:
    from src.services.analytics.consolidated_analytics_service import Consolidated_Analytics_Service
except ImportError:
    # If direct import fails, try from parent module
    from src.services.analytics import Consolidated_Analytics_Service
