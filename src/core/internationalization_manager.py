...
class InternationalizationManager:
    ...
    def add_translation(self, language_code: str, context: str, 
        ...
        try:
            ...
            with self.cache_lock:
                keys_to_remove = [k for k in self.translation_cache.keys() 
...
def main():
    ...
    parser.add_argument("--add-translation", nargs=3, 
                       metavar=("LANG", "CONTEXT", "TEXT"), 
                       help="Add translation (LANG CONTEXT 'TEXT')")
    parser.add_argument("--status", action="store_true", help="Show system status")
    parser.add_argument("--supported-languages", action="store_true", 
