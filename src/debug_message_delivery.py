...
try:
    ...
    print(f"Agent-3 coordinates: {service.agent_coordinates.get('agent_3', 'NOT_FOUND')}")
    ...
    try:
        ...
        print(f"Service PYAUTOGUI_AVAILABLE: {getattr(service, 'PYAUTOGUI_AVAILABLE', 'NOT_FOUND')}")
    except ImportError:
    ...
    if agent_3_coords:
        print(f"Agent-3 coordinates: ({agent_3_coords['input_x']}, {agent_3_coords['input_y']})")
