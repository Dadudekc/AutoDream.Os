...
def demo_perpetual_motion():
    ...
    try:
        ...
        simulation_thread = threading.Thread(
            target=simulate_cursor_conversations,
            args=(engine, 60),
            daemon=True
        )
        ...
        while engine.is_running:
            ...
            print(f"\r   ⏱️  Running: {elapsed:.0f}s | "
                  ...
                  f"🤖 Agents: {stats['registered_agents']}", end="")
    ...
    print(f"   ⏱️  Continuous operation time: {final_stats['continuous_operation_time']:.1f}s")
