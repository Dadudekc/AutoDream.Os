    ...
    async def test_message_types_and_priorities(self, temp_dir):
        ...
        for msg_type in message_types:
            assert msg_type.value in [
                ...
                "query", "notification", "heartbeat", "error"
            ]
...
class TestIntegrationTestingFrameworkSmoke:
    ...
    async def test_test_suite_management(self, temp_dir):
        ...
        mock_test = type('MockTest', (), {
            'test_name': 'Mock Test',
            'run': asyncio.coroutine(lambda: type('MockResult', (), {'status': TestStatus.PASSED})())
        })()
...
class TestEndToEndSmoke:
    ...
    async def test_communication_and_testing_integration(self, temp_dir):
        ...
        # Create test suite
        suite = IntegrationTestSuite("Integration Suite", "Communication and testing integration")
