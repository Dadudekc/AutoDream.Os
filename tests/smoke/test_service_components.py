...
class TestServiceIntegrationSmoke:
    ...
    def test_api_gateway_service_registration(self):
        ...
        gateway.register_service('test_service', 'Test Service', '1.0', 'http://localhost:8000')
    ...
    def test_agent_communication_registration(self):
        ...
        comm.register_agent('test_agent', 'Test Agent', ['performance_monitoring'], 'http://localhost:8001')
...
def pytest_configure(config):
    ...
    config.addinivalue_line(
        "markers", "service: mark test as service component test"
    )
    config.addinivalue_line(
