...
from core.decision_coordination_system import DecisionCoordinationSystem, CoordinationMode
...
def main():
    ...
    task_params = {
        "tasks": [
            {"id": "task_001", "type": "analysis", "priority": "high", "complexity": "medium"},
            {"id": "task_002", "type": "development", "priority": "medium", "complexity": "high"},
            {"id": "task_003", "type": "testing", "priority": "low", "complexity": "low"}
        ],
    ...
    resource_params = {
        ...
        "demands": {
            "cpu": {"Agent-1": 30, "Agent-2": 25, "Agent-3": 20, "Agent-4": 15, "Agent-5": 10},
            "memory": {"Agent-1": 16, "Agent-2": 12, "Agent-3": 8, "Agent-4": 6, "Agent-5": 4},
            "storage": {"Agent-1": 200, "Agent-2": 150, "Agent-3": 100, "Agent-4": 75, "Agent-5": 50}
        }
    }
    ...
    print(f"✅ Resource allocation completed with confidence: {resource_result.confidence:.2f}")
    ...
    for mode in coordination_modes:
        print(f"  📋 {mode.value}: {coordination_system.coordination_protocols[mode]['description']}")
        print(f"     Threshold: {coordination_system.coordination_protocols[mode]['threshold']}")
        print(f"     Timeout: {coordination_system.coordination_protocols[mode]['timeout']}s")
