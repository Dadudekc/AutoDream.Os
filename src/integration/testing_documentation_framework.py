...
class TestingDocumentationFramework:
    ...
    def develop_documentation_system(self) -> dict[str, Any]:
        ...
        return {
            ...
            "user_friendly_avg": sum(r["user_friendly_score"] for r in documentation_results)
            / len(documentation_results),
            "agent_friendly_avg": sum(r["agent_friendly_score"] for r in documentation_results)
            / len(documentation_results),
        }
...
def run_testing_documentation_framework() -> dict[str, Any]:
    ...
    return {"framework_summary": summary, "testing_documentation_report": report}
