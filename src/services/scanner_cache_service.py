    ...
    def get_cache_stats(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats = {
                ...
                'cache_usage_percent': (current_size / self.max_cache_size) * 100 if self.max_cache_size > 0 else 0,
            ...
            if cache_ages:
                ...
                stats['average_cache_age_hours'] = round(sum(cache_ages) / len(cache_ages) / 3600, 2)
