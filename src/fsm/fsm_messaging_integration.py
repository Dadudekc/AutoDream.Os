...
from .fsm_registry import AgentState, read_agent_state
...
class FSMMessagingIntegration:
    ...
    def get_agent_fsm_state(self, agent_id: str) -> str | None:
    ...
    def _get_last_transition(self, agent_id: str) -> dict[str, Any] | None:
...
def create_fsm_enhanced_message(
    agent_id: str, base_message: str, fsm_integration: FSMMessagingIntegration
) -> str:
