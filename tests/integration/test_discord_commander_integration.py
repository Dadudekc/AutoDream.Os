...
from src.services.discord_commander import (
    DiscordConfig, DiscordConnectionManager, DiscordCommandRegistry,
    DiscordEventManager, DiscordStatusMonitor, AgentCommands,
    SystemCommands, SwarmCommands, CommandManager, DiscordCommanderBot
)
...
class TestCommandManagerIntegration:
    ...
    def test_command_manager_initialization(self, mock_messaging_service):
        ...
        expected_commands = [
            "agent_status", "send_message", "agent_coordinates",
            "system_status", "project_info", "swarm_status", "swarm_coordinate"
        ]
