...
try:
    from src.services.messaging.interfaces.messaging_interfaces import Messaging_Interfaces
except ImportError:
    # If direct import fails, try from parent module
    from src.services.messaging.interfaces import Messaging_Interfaces
