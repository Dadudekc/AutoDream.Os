...
class TestPerpetualMotionEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.core.fsm_cursor_integration.CursorResponseCapture') as mock_cursor_capture:
            with patch('src.core.fsm_cursor_integration.PerformanceProfiler') as mock_performance_profiler:
                with patch('src.core.fsm_cursor_integration.HealthMonitor') as mock_health_monitor:
    ...
    def test_default_triggers_setup(self):
        ...
        expected_trigger_ids = ["code_review", "documentation", "testing", "optimization"]
        ...
        with patch.object(self.engine.cursor_capture, 'start_capture') as mock_start_capture:
            with patch.object(self.engine.performance_profiler, 'start_monitoring') as mock_start_perf:
                with patch.object(self.engine.health_monitor, 'start_monitoring') as mock_start_health:
                    with patch.object(self.engine, '_perpetual_motion_loop') as mock_loop:
    ...
    def test_message_trigger_detection(self):
        ...
        test_message = {
            "role": "assistant",
            "content": "This code needs a code review"
        }
