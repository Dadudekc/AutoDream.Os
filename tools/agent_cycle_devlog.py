...
from services.agent_devlog_automation import (
    AgentDevlogAutomation,
    auto_create_cycle_devlog,
    auto_create_cycle_start,
    auto_create_cycle_completion
)
...
Examples:
  ...
  python tools/agent_cycle_devlog.py --agent Agent-4 --coordination --message "Status update needed" --target Agent-2
    ...
    parser.add_argument(
        "--action",
        type=str,
        help="Action description for devlog"
    )
    ...
    parser.add_argument(
        "--details",
        type=str,
        help="Additional details for the devlog"
    )
    ...
    parser.add_argument(
        "--cycle-start",
        action="store_true",
        help="Create cycle start devlog"
    )
    
    parser.add_argument(
        "--focus",
        type=str,
        help="Focus area for cycle start"
    )
    
    parser.add_argument(
        "--cycle-complete",
        action="store_true",
        help="Create cycle completion devlog"
    )
    
    parser.add_argument(
        "--results",
        type=str,
        help="Results for cycle completion"
    )
    ...
    parser.add_argument(
        "--task-assignment",
        action="store_true",
        help="Create task assignment devlog"
    )
    
    parser.add_argument(
        "--task",
        type=str,
        help="Task description for assignment"
    )
    
    parser.add_argument(
        "--assigned-by",
        type=str,
        help="Agent who assigned the task"
    )
    ...
    parser.add_argument(
        "--coordination",
        action="store_true",
        help="Create coordination devlog"
    )
    
    parser.add_argument(
        "--message",
        type=str,
        help="Coordination message"
    )
    
    parser.add_argument(
        "--target",
        type=str,
        help="Target agent for coordination"
    )
    ...
    parser.add_argument(
        "--no-discord",
        action="store_true",
        help="Create devlog file only, don't post to Discord"
    )
