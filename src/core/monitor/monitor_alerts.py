...
class AlertManager:
    ...
    def create_alert(self, alert_type: AlertType, level: AlertLevel, message: str, 
                    agent_id: Optional[str] = None, details: Optional[Dict[str, Any]] = None) -> Alert:
        """Create a new alert"""
    ...
    def create_agent_offline_alert(self, agent_id: str, details: Optional[Dict[str, Any]] = None) -> Alert:
    ...
    def create_performance_alert(self, agent_id: str, performance_score: float, 
    ...
    def create_system_resource_alert(self, resource_type: str, usage_percent: float, 
                                   details: Optional[Dict[str, Any]] = None) -> Alert:
        ...
        return self.create_alert(
            AlertType.SYSTEM_RESOURCE_LOW,
            level,
            message,
            details=details
        )
    
    def create_health_alert(self, agent_id: str, health_score: float, 
                          warnings: List[str], details: Optional[Dict[str, Any]] = None) -> Alert:
        """Create alert for health issues"""
        if health_score < 30:
            level = AlertLevel.CRITICAL
            message = f"Agent {agent_id} has critical health issues (score: {health_score})"
    ...
    def get_alert_summary(self) -> Dict[str, Any]:
        ...
        for alert_type in AlertType:
            type_counts[alert_type.value] = len([a for a in self.alerts if a.alert_type == alert_type])
    ...
    def _cleanup_old_alerts(self):
        ...
        self.alerts = [a for a in self.alerts 
                      if current_time - a.timestamp < retention_seconds]
