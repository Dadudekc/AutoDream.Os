...
class AgentContextDetector:
    ...
    def _detect_agent_context(self) -> Optional[str]:
    ...
    def _detect_from_workspace(self) -> Optional[str]:
    ...
    def _detect_from_config(self) -> Optional[str]:
    ...
    def _extract_agent_from_path(self, path: Path) -> Optional[str]:
    ...
    def _read_agent_from_config(self, config_path: Path) -> Optional[str]:
    ...
    def _extract_agent_from_string(self, text: str) -> Optional[str]:
