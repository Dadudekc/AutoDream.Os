...
if __name__ == "__main__":
    ...
    print(
        f"✅ Permission granted: {db.check_permission('Agent-1', 'test-repo', GitHubPermissionLevel.WRITE)}"
    )
    ...
    print(
        f"📊 Database exported: {len(exported['permissions'])} permissions, {len(exported['operations'])} operations"
    )
