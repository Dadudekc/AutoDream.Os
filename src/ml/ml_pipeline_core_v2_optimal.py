...
V2 Compliance: 296 lines, optimized.
"""
    ...
    def train_model(self,
        ...
        try:
            ...
            if hasattr(model, 'fit'):
                # TensorFlow training
                validation_data = (training_data.validation_features,
                                 training_data.validation_labels) if training_data.validation_features is not None else None
