...
class TestTaskScheduler(unittest.TestCase):
    ...
    def test_task_retrieval(self, mock_exists, mock_open):
        ...
        self.scheduler.create_task("Task 1", "Desc 1", "Agent-1", "TestAgent", TaskPriority.HIGH)
        self.scheduler.create_task("Task 2", "Desc 2", "Agent-1", "TestAgent", TaskPriority.LOW)
        ...
        high_priority_tasks = self.scheduler.get_tasks("Agent-1", priority=TaskPriority.HIGH)
