...
def demo_fsm_orchestrator():
    ...
    try:
        ...
        fsm_orchestrator.update_task_state(
            task1_id, TaskState.IN_PROGRESS, "Agent-2",
        ...
        # Complete task 2
        fsm_orchestrator.update_task_state(
            task2_id, TaskState.COMPLETED, "Agent-3",
        ...
        # Block task 3
        fsm_orchestrator.update_task_state(
            task3_id, TaskState.BLOCKED, "Agent-4",
...
def demo_complete_fsm_workflow():
    ...
    try:
        ...
        print(f"✅ Created coordinated task sequence: {len([task1, task2, task3, task4])} tasks")
...
def main():
    ...
    print("   - Unified Launcher V2: python src/launchers/unified_launcher_v2.py --test")
    print("   - Complete demo: python examples/demo_fsm_integration.py")
    print("   - Agent swarm: python src/launchers/unified_launcher_v2.py --workflow agent_swarm")
