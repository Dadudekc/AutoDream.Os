...
class DeploymentValidator:
    ...
    def _generate_validation_report(self) -> None:
        ...
        self.validation_results["overall_status"] = "success" if success_rate >= 75 else "partial" if success_rate >= 50 else "failed"
        ...
        for name, status in components.items():
            status_icon = "✅" if status.get("status") in ["connected", "deployed", "operational"] else "❌"
