...
def send_coordination_message(
    agent_id: str, message: str, priority: str = "NORMAL", tag: str = "COORDINATION"
):
...
def broadcast_coordination_message(
    message: str, priority: str = "NORMAL", tag: str = "COORDINATION"
):
