...
class HealthThresholdTesting:
        ...
        try:
            ...
            for metric_type, value, expected_status in test_cases:
                ...
                if threshold:
                    ...
                    assert actual_status == expected_status, f"Expected {expected_status}, got {actual_status} for {metric_type}={value}"
    ...
    def run_performance_test(
        ...
        try:
            self.logger.info(f"Running performance tests with {iterations} iterations...")
            ...
            for i in range(iterations):
                ...
                set_threshold_func(metric_name, 50.0, 100.0, "count", f"Performance test {i}")
