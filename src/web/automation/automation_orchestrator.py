...
class AutomationOrchestrator:
    ...
    async def _generate_website_step(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Generate website
            website_path = self.website_generator.generate_website(
                website_config, pages
            )
    ...
    async def _run_automation_step(self, config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            for task in tasks:
                task_result = await self._execute_automation_task(
    ...
    def _run_navigation_sync(
        self, url: str, config: AutomationConfig
    ) -> Dict[str, Any]:
    ...
    def _run_screenshot_sync(
        self, filename: str, config: AutomationConfig
    ) -> Dict[str, Any]:
