...
class TestObjectDetector(unittest.TestCase):
    ...
    def test_detect_objects_template_matching(self, mock_match_template):
        ...
        with patch('numpy.where') as mock_where:
            ...
            template_objects = [obj for obj in objects if obj.object_type == "template_match"]
    ...
    def test_detect_by_color(self, mock_inrange, mock_cvtcolor, mock_findcontours):
        ...
        with patch('cv2.contourArea', return_value=200), \
             patch('cv2.boundingRect', return_value=(10, 10, 10, 10)):
...
class TestGameStateAnalyzer(unittest.TestCase):
    ...
    def test_determine_game_state_banking(self):
        ...
        test_image = np.zeros((100, 100, 3), dtype=np.uint8)
        bank_objects = [
            GameObjectData("obj1", "bank interface", (50, 50), "ui", 0.9)
        ]
    ...
    def test_generate_recommendations_opportunities(self):
        ...
        click_actions = [r for r in recommendations 
                        if r.decision_type == AIDecisionType.CLICK_OBJECT]
    ...
    def test_calculate_confidence(self):
        ...
        confidence = self.analyzer._calculate_confidence(GameState.IDLE, high_conf_objects)
