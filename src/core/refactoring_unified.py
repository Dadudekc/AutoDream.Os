#!/usr/bin/env python3
"""
🔄 UNIFIED CORE WRAPPER - Refactoring
==================================================

This file replaces the original refactoring_unified.py with a wrapper
that uses the unified core system.

Original file: /workspace/src/core/refactoring_unified.py
Core type: refactoring
Migration date: 2025-09-14T20:22:03.968185
...
def main():
    ...
    try:
        ...
        print(f"Error running refactoring component: {e}")
        sys.exit(1)
