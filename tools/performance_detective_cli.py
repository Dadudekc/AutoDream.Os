...
class PerformanceDetectiveCLI:
    ...
    def investigate_performance(self, target_path: str) -> bool:
        ...
        try:
            ...
            print("✅ Performance investigation completed!")
            print(f"🎯 Bottlenecks found: {investigation_result['findings']['bottlenecks']}")
            print(
                f"💡 Optimization opportunities: {investigation_result['findings']['optimization_opportunities']}"
            )
...
def main():
    ...
    parser.add_argument(
        "--analyze-bottlenecks", metavar="PATH", help="Analyze performance bottlenecks"
    )
