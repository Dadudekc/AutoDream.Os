"""
Basic unit tests for src.core.backup_disaster_recovery.backup_scheduler
...
try:
    from src.core.backup_disaster_recovery.backup_scheduler import Backup_Scheduler
except ImportError:
    # If direct import fails, try from parent module
    from src.core.backup_disaster_recovery import Backup_Scheduler


class TestBackup_Scheduler:
    """Basic test suite for Backup_Scheduler."""

    def setup_method(self):
        """Set up test fixtures."""
        self.instance = Backup_Scheduler()

    def test_initialization(self):
        """Test that the component can be initialized."""
        assert self.instance is not None
        assert isinstance(self.instance, Backup_Scheduler)
