...
from v3.v3_012_ui_components import ComponentFactory, ComponentRenderer, UIComponent
...
class ScreenFactory:
    ...
    def create_login_screen(self) -> Screen:
        ...
        components = [
            ...
            self.component_factory.create_button(
                "register_btn", "Register", "onRegister", "secondary"
            ),
        ]
        ...
        return Screen(
            ...
            navigation={"next_screen": "dashboard", "back_enabled": False},
            styles={"backgroundColor": "#F2F2F7", "padding": "20px"},
    ...
    def create_dashboard_screen(self) -> Screen:
        ...
        components = [
            ...
            self.component_factory.create_card(
                "recent_card", "Recent Activity", "View recent activity"
            ),
    ...
    def create_settings_screen(self) -> Screen:
        ...
        components = [
            ...
            self.component_factory.create_card(
                "notifications_card", "Notifications", "Notification preferences"
            ),
        ...
        return Screen(
            ...
            components=components,
            navigation={"next_screen": "profile", "back_enabled": True},
            styles={"backgroundColor": "#F2F2F7", "padding": "16px"},
            created_at=datetime.now(),
        )
    ...
    def create_profile_screen(self) -> Screen:
        ...
        components = [
            ...
            self.component_factory.create_card(
                "avatar_card", "Profile Picture", "Update your photo"
            ),
        ...
        return Screen(
            ...
            components=components,
            navigation={"next_screen": "dashboard", "back_enabled": True},
            styles={"backgroundColor": "#FFFFFF", "padding": "16px"},
            created_at=datetime.now(),
        )
