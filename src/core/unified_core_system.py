...
class UnifiedCoreSystem:
    ...
    def get_component(self, name: str) -> BaseCoreComponent | None:
    ...
    def get_system_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "components": {
                name: component.get_status().value for name, component in self.components.items()
            },
...
if __name__ == "__main__":
    ...
    if system.initialize():
        ...
        if doc_mgr:
            ...
            logger.info(f"✅ Documentation system working: {len(results)} results")
