...
class TestBusinessIntelligenceIntegration:
    ...
    def setup_teardown(self):
        ...
        self.portfolio_dir = self.temp_dir / "portfolio_data"
        self.risk_dir = self.temp_dir / "risk_data"
        self.market_dir = self.temp_dir / "market_data"
