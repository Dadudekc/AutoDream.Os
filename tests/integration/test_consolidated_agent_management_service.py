...
try:
    from src.services.consolidated_agent_management_service import Consolidated_Agent_Management_Service
except ImportError:
    # If direct import fails, try from parent module
    from src.services import Consolidated_Agent_Management_Service
