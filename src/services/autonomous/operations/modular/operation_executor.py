...
class OperationExecutor:
    ...
    async def execute_operation(self, operation: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.info(f"{self.core.agent_id}: Executed operation '{operation.get('name', 'Unknown')}' of type '{operation_type}'")
            return result
            
        except Exception as e:
            logger.error(f"{self.core.agent_id}: Failed to execute operation '{operation.get('name', 'Unknown')}': {e}")
