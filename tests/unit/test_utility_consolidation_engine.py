...
try:
    from src.core.consolidation.utility_consolidation.utility_consolidation_engine import Utility_Consolidation_Engine
except ImportError:
    # If direct import fails, try from parent module
    from src.core.consolidation.utility_consolidation import Utility_Consolidation_Engine
