...
try:
    from src.services.thea.authentication.thea_authentication_service import Thea_Authentication_Service
except ImportError:
    # If direct import fails, try from parent module
    from src.services.thea.authentication import Thea_Authentication_Service
