...
class BetaTransformationService:
    ...
    def get_status(self):
        return {
            ...
            "active_transformations": sum(1 for t in self.transformations.values() if t["status"] == "executing"),
...
def main():
    ...
    if args.test:
        ...
        trans_id = service.create_transformation("Test Transformation", "A test transformation for validation")
