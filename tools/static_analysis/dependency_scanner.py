...
class DependencyScanner:
    ...
    def _generate_dependency_summary(self, tools_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        for tool_name, tool_result in tools_results.items():
            ...
            if tool_result['status'] == 'success':
                ...
                if tool_name == 'safety':
                    ...
                    summary['high_severity'] += len(data)  # Safety issues are typically high severity
        ...
        if summary['high_severity'] > 0:
            summary['recommendations'].append("🚨 CRITICAL: Address high-severity vulnerabilities immediately")
        
        if summary['medium_severity'] > 5:
            summary['recommendations'].append("⚠️  WARNING: Multiple medium-severity vulnerabilities detected")
