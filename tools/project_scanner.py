"""Main project scanner with CLI interface."""
...
from .file_processor import FileProcessor, MultibotManager
from .report_generator import ReportGenerator, ModularReportGenerator
