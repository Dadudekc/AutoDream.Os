...
from services.response_capture_service import ResponseCaptureService, ResponseData, CaptureStrategy
...
def demo_integration_workflow():
    ...
    try:
        ...
        if agent_service.coordinates and "5-agent" in agent_service.coordinates:
            ...
            # Send message
            success = agent_service.send_message("Agent-1", "Agent-2", "Please analyze the response capture system", "TASK")
            if success:
