...
class StrategicConsultationCore:
    ...
    def consult_command(self, question: str, template: str = None, context: str = None) -> Dict[str, Any]:
        """Execute strategic consultation command."""
        try:
            logger.info(f"Starting consultation: template={template}, question='{question[:50]}...'")
    ...
    def _prepare_consultation_request(self, question: str, template: str, context: str) -> Dict[str, Any]:
        """Prepare consultation request."""
        request = {
            "question": question,
    ...
    def _format_consultation_response(self, result: Dict[str, Any], consultation_id: str) -> Dict[str, Any]:
    ...
    def get_consultation_history(self, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            consultation_files = sorted(self.consultation_dir.glob("*.json"), 
...
def main():
    ...
    result = core.consult_command(
        "What should be our next priority for the project?",
