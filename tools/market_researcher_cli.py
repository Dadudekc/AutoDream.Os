...
class MarketResearcherCLI:
    ...
    def research_market(self, market: str, research_type: str = "comprehensive") -> bool:
        ...
        try:
            ...
            print(f"📈 Volatility Regime: {research_result['findings']['volatility_regime'].upper()}")
            print(f"🔗 Correlation Regime: {research_result['findings']['correlation_regime'].upper()}")
            ...
            print(f"  🔄 Sector Rotation: {research_result['trends']['sector_rotation'].replace('_', ' ').title()}")
...
def main():
    ...
    parser.add_argument("--research-type", choices=["comprehensive", "technical", "fundamental", "sentiment"], default="comprehensive", help="Research type")
