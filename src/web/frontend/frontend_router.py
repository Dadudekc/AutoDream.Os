...
class FrontendRouter:
    ...
    def _run_before_hooks(self, route_config: RouteConfig, 
                          route_params: Dict[str, Any], 
                          query_params: Dict[str, Any]):
    ...
    def _run_after_hooks(self, route_config: RouteConfig, 
                         route_params: Dict[str, Any], 
                         query_params: Dict[str, Any]):
    ...
    def _update_navigation_state(self, path: str, route_params: Dict[str, Any], 
                                query_params: Dict[str, Any], replace: bool):
        """Update navigation state"""
        try:
            # Update navigation state
            if not replace:
                self.navigation_state.previous_route = self.navigation_state.current_route
