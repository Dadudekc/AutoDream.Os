...
class V2StandaloneDemo(QMainWindow):
    ...
    def setup_connections(self):
        ...
        self.trading_dashboard.buy_button.clicked.connect(lambda: self.show_trading_action("BUY"))
        self.trading_dashboard.sell_button.clicked.connect(lambda: self.show_trading_action("SELL"))
        self.trading_dashboard.hold_button.clicked.connect(lambda: self.show_trading_action("HOLD"))
