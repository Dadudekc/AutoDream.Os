...
class BaseTestRunner(ABC):
    ...
    def discover_tests(self, test_type: Optional[str] = None, 
                      pattern: str = "test_*.py") -> List[Path]:
    ...
    def build_pytest_command(self, test_paths: List[Path], 
                           coverage: bool = True,
                           parallel: bool = False,
                           verbose: bool = True,
                           markers: Optional[List[str]] = None) -> List[str]:
