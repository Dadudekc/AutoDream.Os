...
class WindowsCompatibleTestRunner:
    ...
    def run_workflow_tests(self) -> Tuple[bool, Dict[str, Any]]:
        ...
        try:
            ...
            ], capture_output=True, text=True, cwd=self.project_root, env=self.env, encoding='utf-8')
        ...
        try:
            report = {
                ...
                "summary": {
                    ...
                    "overall_status": "passed" if all(r.get("status") == "passed" for r in self.test_results.values()) else "failed"
                }
            }
...
def main():
    ...
    parser.add_argument("--suite", choices=["workflow", "discord", "performance", "compliance", "all"], 
