...
class CommandUnderstandingSystem:
    ...
    def process_command(self, text: str, sender: str, recipient: str, 
                       priority: CommandPriority = CommandPriority.MEDIUM) -> Dict[str, Any]:
...
def process_command(text: str, sender: str, recipient: str, 
                   priority: CommandPriority = CommandPriority.MEDIUM) -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    test_commands = [
        ...
        ("What is the status of the performance monitoring system?", "Agent-1", "Agent-3", CommandPriority.MEDIUM),
        ("Emergency: Critical error in database system", "Agent-2", "Agent-3", CommandPriority.CRITICAL),
        ("Coordinate with Agent-1 on API integration", "Agent-4", "Agent-3", CommandPriority.MEDIUM)
    ]
