#!/usr/bin/env python3
"""
Message Validator - Redirect to Unified System
=============================================
...
from core.unified_validation_system import validate_message, ValidationIssue

# Re-export for backward compatibility
__all__ = ['validate_message', 'ValidationIssue']