...
from core.advanced_workflow_engine import (
    AdvancedWorkflowEngine, WorkflowType, WorkflowPriority, 
    WorkflowStep, OptimizationStrategy
)
...
class AdvancedWorkflowIntegrationDemo:
    ...
    def _test_basic_workflow_operations(self):
        ...
        workflow_id = self.workflow_engine.create_dynamic_workflow(
            ...
            [OptimizationStrategy.PERFORMANCE, OptimizationStrategy.RESOURCE_EFFICIENCY]
        )
    ...
    def _test_workflow_optimization(self):
        ...
        optimization_workflow_id = self.workflow_engine.create_dynamic_workflow(
            ...
            optimization_steps,
            WorkflowPriority.HIGH,
            [OptimizationStrategy.PERFORMANCE, OptimizationStrategy.THROUGHPUT_MAXIMIZATION]
        )
        ...
        assert "total_optimizations" in optimization_summary, "Optimization summary missing"
        print(f"    ✅ Optimization summary: {optimization_summary['total_optimizations']} optimizations")
    ...
    def _test_contract_integration(self):
        ...
        execution_id = self.workflow_engine.execute_workflow(contract_workflow_id, "test_agent_001")
        ...
        workflow_contracts = [c for c in pending_contracts if "Workflow Execution" in c.title]
        
        if workflow_contracts:
            print(f"    ✅ Contract created for workflow execution: {len(workflow_contracts)} contracts")
        else:
    ...
    def _test_system_performance(self):
        ...
        print(f"    ✅ Created {len(workflow_ids)} workflows in {creation_time:.3f} seconds")
        ...
        print(f"    ✅ Started {len(execution_ids)} executions in {execution_time:.3f} seconds")
