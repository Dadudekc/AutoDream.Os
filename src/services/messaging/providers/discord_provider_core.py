#!/usr/bin/env python3
"""
Deprecation shim for src/services/messaging/providers/discord_provider_core.py
...
# Deprecation warning
warnings.warn(
    "Module src/services/messaging/providers/discord_provider_core.py is deprecated. Use src.services.discord_commander.discord_post_client directly.",
    DeprecationWarning,
    stacklevel=2,
)
