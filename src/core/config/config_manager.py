...
class UnifiedConfigManager:
    ...
    CONFIG_SCHEMA = {
        ...
        "ai": {
            ...
            "temperature": float,
            "max_tokens": int,
            "memory": {"max_entries": int, "min_score": float},
        },
        "discord": {"bot_token": str, "channel_id": int, "enabled": bool},
        "database": {"url": str, "pool_size": int, "timeout": float},
    }
    ...
    def _get_default_config(self) -> dict[str, Any]:
        ...
        return {
            ...
            "ai": {
                ...
                "temperature": 0.7,
                "max_tokens": 2000,
                "memory": {"max_entries": 1000, "min_score": 0.5},
            },
            "discord": {"bot_token": "", "channel_id": 0, "enabled": False},
            "database": {"url": "sqlite:///memory.db", "pool_size": 5, "timeout": 30.0},
        }
