...
class AgentMetrics:
    ...
    time_last_active: Optional[datetime] = None
...
class Agent:
    ...
    def is_available(self) -> bool:
        ...
        return (self._status == AgentStatus.ACTIVE and 
                len(self._current_tasks) < self._configuration.max_concurrent_tasks)
    ...
    def is_healthy(self) -> bool:
        ...
        if self._metrics.time_last_active:
            ...
            return time_since_active.total_seconds() < (self._configuration.health_check_interval * 2)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'metrics': {
                ...
                'time_last_active': self._metrics.time_last_active.isoformat() if self._metrics.time_last_active else None,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Agent':
        ...
        agent._metrics = AgentMetrics(
            ...
            time_last_active=datetime.fromisoformat(metrics_data['time_last_active']) if metrics_data['time_last_active'] else None,
