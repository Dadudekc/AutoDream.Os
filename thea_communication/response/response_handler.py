...
class ResponseHandler:
    ...
    def capture_response(self, use_selenium: bool = True, driver=None) -> str | None:
    ...
    def _capture_selenium_response(self, driver, timestamp: str) -> str | None:
    ...
    def _capture_manual_response(self, timestamp: str) -> str | None:
    ...
    def _extract_response_text(self, driver) -> str:
        ...
        try:
            response_elements = driver.find_elements(
                By.CSS_SELECTOR, "[data-testid^='conversation-turn-']"
            )
