...
class Agent5Phase1BISupportCore:
    ...
    def _create_mock_bi_system(self):
        ...
        class MockBISystem:
            ...
            def update_consolidation_progress(self, chunk_id, agent_id, phase, files_processed, files_target, blockers):
                pass
    ...
    def get_chunk_coordination_status(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "active_chunks": sum(1 for chunk in self.chunk_coordination.values() if chunk["status"] == "monitoring"),
