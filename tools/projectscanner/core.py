"""Core ProjectScanner class for project analysis."""
...
from .report_generators import ModularReportGenerator, ReportGenerator
from .workers import MultibotManager
...
class ProjectScanner:
    ...
    def scan_project(self, progress_callback: Callable | None = None):
        ...
        self.report_generator.generate_legacy_reports()
        self.save_cache()
        logger.info(
    ...
    def generate_init_files(self, overwrite: bool = True):
        ...
        # This would be implemented in the report generator
        pass
