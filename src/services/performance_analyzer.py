...
# Import the service
from src.services.performance_analyzer import Performance_AnalyzerService

# Initialize service
service = Performance_AnalyzerService()
...
container = Container()
service = container.get(Performance_AnalyzerService)
