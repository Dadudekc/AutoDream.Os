...
from src.team_beta.consolidation_analyzer_core import (
    SystemConsolidationAnalyzerCore, ConsolidationStatus, DuplicationSeverity
)
...
def create_parser() -> argparse.ArgumentParser:
    ...
    update_parser.add_argument('status', choices=[s.value for s in ConsolidationStatus],
                              help='New status')
    ...
    list_parser.add_argument('--severity', choices=[s.value for s in DuplicationSeverity],
                            help='Filter by severity')
    list_parser.add_argument('--status', choices=[s.value for s in ConsolidationStatus],
...
def handle_update(args, analyzer: SystemConsolidationAnalyzerCore) -> None:
    ...
    analyzer.manage_consolidation_operations(
        "update_status",
        name=args.name,
        status=status
    )
