...
class AuthPerformanceMonitor:
    ...
    def _default_config(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "performance_thresholds": {
                "auth_duration": {"warning": 0.5, "critical": 1.0},  # 500ms  # 1 second
    ...
    def _detect_performance_degradation(
        self, current_value: float, baseline: Dict[str, Any], metric_name: str
    ) -> Optional[float]:
        ...
        try:
            for metric_name, thresholds in self.performance_thresholds.items():
                ...
                if "warning" in thresholds and current_value > thresholds["warning"]:
                    self._create_alert(
                        "warning", metric_name, current_value, thresholds["warning"]
                    )

                # Check critical threshold
                if "critical" in thresholds and current_value > thresholds["critical"]:
                    self._create_alert(
                        "critical", metric_name, current_value, thresholds["critical"]
                    )
    ...
    def _create_alert(
        self, alert_type: str, metric_name: str, current_value: float, threshold: float
    ):
    ...
    def _calculate_performance_indicators(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if (
                "success_rate" in self.metrics_history
                and self.metrics_history["success_rate"]
            ):
            ...
            # Authentication duration
            if (
                "auth_duration" in self.metrics_history
                and self.metrics_history["auth_duration"]
            ):
            ...
            # Throughput
            if (
                "auth_per_second" in self.metrics_history
                and self.metrics_history["auth_per_second"]
            ):
    ...
    def _generate_recommendations(self, summary: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            if "current_auth_duration" in summary.get("performance_indicators", {}):
                auth_duration = summary["performance_indicators"][
                    "current_auth_duration"
                ]
            ...
            if system_health in ["fair", "poor"]:
                recommendations.append(
                    "Perform system health assessment and optimization"
                )
