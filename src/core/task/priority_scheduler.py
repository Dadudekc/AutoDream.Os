...
class PriorityScheduler:
        ...
        try:
            ...
            with self._lock:
                ...
                if task.retries < task.max_retries:
                    ...
                    logger.info(f"Task {task.id} scheduled for retry {task.retries}/{task.max_retries}")
                else:
    ...
    def _get_task_handler(self, task: Task) -> Optional[Callable]:
    ...
    def get_task_stats(self) -> Dict[str, Any]:
        ...
        with self._lock:
            return {
                ...
                "retrying_tasks": sum(1 for t in self.tasks.values() if t.status == TaskStatus.RETRYING)
            }
