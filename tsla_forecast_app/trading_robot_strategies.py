...
class RSIMeanReversionStrategy(TradingStrategy):
    ...
    def __init__(self):
        ...
        super().__init__(
            "RSI Mean Reversion", "Buy when RSI is oversold (<30), sell when overbought (>70)"
        )
        self.rsi_period = 14
...
class BollingerBandsStrategy(TradingStrategy):
    ...
    def analyze(self, data: dict[str, Any]) -> str | None:
        ...
        # Calculate Bollinger Bands
        bands = self.calculate_bollinger_bands(self.price_history, self.period, self.std_dev)
...
class MomentumStrategy(TradingStrategy):
    ...
    def __init__(self):
        ...
        super().__init__(
            "Momentum Strategy", "Buy on strong upward momentum, sell on downward momentum"
        )
...
class StrategyManager:
    ...
    def get_strategy(self, name: str) -> TradingStrategy | None:
    ...
    def analyze_market(self, data: dict[str, Any]) -> str | None:
