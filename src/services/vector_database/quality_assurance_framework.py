...
class QualityChecker:
    ...
    def add_metric(self, gate: QualityGate, name: str, value: float, threshold: float, level: QualityLevel) -> None:
    ...
    def get_metric(self, gate: QualityGate, name: str) -> Optional[QualityMetric]:
