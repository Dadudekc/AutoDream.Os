...
from .ml_monitoring_models import MetricData, Alert, MetricType, AlertSeverity
...
class MLMonitoringCore:
    ...
    def record_metric(self, name: str, value: float, metric_type: MetricType,
                     labels: Dict[str, str] = None, model_name: str = None,
    ...
    def record_prediction_metrics(self, model_name: str, version: str, 
                                 predictions: List[float], actuals: List[float]) -> None:
    ...
    def record_training_metrics(self, model_name: str, version: str,
        ...
        self.record_metric("training_accuracy", accuracy, MetricType.GAUGE, labels, model_name, version)
