...
from src.v3.v3_011_api_gateway import APIGateway, AuthMethod
...
class APIGatewayCLI:
    ...
    def __init__(self):
        ...
        self.gateway: APIGateway | None = None
    ...
    def generate_docs(self, output_file: str | None = None) -> int:
    ...
    def show_health(self) -> int:
        ...
        try:
            ...
            print(
                f"   Rate Limiting: {'Enabled' if health['rate_limiting_enabled'] else 'Disabled'}"
            )
            print(
                f"   Authentication: {'Enabled' if health['authentication_enabled'] else 'Disabled'}"
            )
    ...
    def configure_rate_limiting(self, requests_per_minute: int, burst_limit: int = None) -> int:
...
def main():
    ...
    auth_parser.add_argument(
        "method", choices=["jwt", "api_key", "basic", "none"], help="Authentication method"
    )
