...
class VideoCaptureService:
    ...
    def start_webcam_capture(self, device_id: int = 0, callback: Optional[Callable] = None) -> bool:
        """
    ...
    def _webcam_capture_loop(self, cap: cv2.VideoCapture, device_id: int, callback: Optional[Callable]):
    ...
    def start_screen_capture(self, region: Optional[tuple] = None, callback: Optional[Callable] = None) -> bool:
        """
    ...
    def _screen_capture_loop(self, region: Optional[tuple], callback: Optional[Callable]):
