...
class TaskValidator:
    ...
    VALID_TRANSITIONS = {
        ...
        TaskState.ONBOARDING: [TaskState.IN_PROGRESS, TaskState.BLOCKED, TaskState.CANCELLED],
        TaskState.IN_PROGRESS: [TaskState.COMPLETED, TaskState.BLOCKED, TaskState.FAILED, TaskState.CANCELLED],
    ...
    @classmethod
    def validate_transition(cls, current_state: TaskState, new_state: TaskState) -> bool:
