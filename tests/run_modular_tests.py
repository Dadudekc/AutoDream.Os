...
class ModularTestRunner:
    ...
    def __init__(self):
        self.test_categories = {
            ...
            'database': {
                ...
                'markers': ['database', 'migration', 'schema', 'unit', 'integration', 'performance']
            },
            'utils': {
                'path': 'utils/',
    ...
    def run_tests(self, category: str = None, test_type: str = None, 
...
def main():
    ...
    parser.add_argument('--category', choices=['messaging', 'discord', 'database', 'utils', 'all'],
                       help='Test category to run')
    parser.add_argument('--type', choices=['unit', 'integration', 'performance', 'slow'],
