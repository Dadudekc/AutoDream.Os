#!/usr/bin/env python3
"""
🔄 UNIFIED CORE WRAPPER - Ssot
==================================================

This file replaces the original ssot_unified.py with a wrapper
that uses the unified core system.

Original file: /workspace/src/core/ssot_unified.py
Core type: ssot
Migration date: 2025-09-14T20:22:03.965900
...
def main():
    ...
    try:
        ...
        component_type = ComponentType.SSOT
        ...
        print(f"Error running ssot component: {e}")
        sys.exit(1)
