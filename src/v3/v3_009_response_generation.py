...
class ResponseGenerator:
    ...
    def generate_response(
        ...
        format_type: ResponseFormat = ResponseFormat.STRUCTURED,
    ) -> GeneratedResponse:
    ...
    def _select_template(
        ...
        matching_templates = [t for t in templates if t.tone == tone and t.format == format_type]
    ...
    def _get_default_template(
        self, category: str, tone: ResponseTone, format_type: ResponseFormat
    ) -> ResponseTemplate:
    ...
    def _calculate_confidence(self, template: ResponseTemplate, context: dict[str, Any]) -> float:
        ...
        variable_confidence = (
            provided_variables / len(template.variables) if template.variables else 0.0
        )
        ...
        # Combined confidence
        confidence = (
            (base_confidence * 0.4) + (variable_confidence * 0.3) + (condition_confidence * 0.3)
        )
...
class ResponseGenerationSystem:
    ...
    def get_generation_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "average_confidence": sum(r.confidence for r in self.generation_history)
    ...
    def get_system_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "total_templates": sum(
                len(templates) for templates in self.generator.templates.values()
            ),
...
if __name__ == "__main__":
    ...
    for test in test_contexts:
        ...
        response = generate_response(test["category"], test["context"], test["tone"])
