...
class TradingRobot(QMainWindow):
    ...
    def create_portfolio_tab(self):
        ...
        self.portfolio_table.setHorizontalHeaderLabels(["Asset", "Quantity", "Price", "Value"])
    ...
    def can_trade(self, action, quantity):
        ...
        if action == "buy":
            required_cash = quantity * (
                self.current_data.get("price", 0) if self.current_data else 0
            )
