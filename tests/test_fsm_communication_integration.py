...
class TestFSMCommunicationIntegration(unittest.TestCase):
    ...
    def test_error_handling(self):
        ...
        with patch.object(self.fsm_core, 'create_task', side_effect=Exception("Test error")):
    ...
    def test_coordination_monitoring(self):
        ...
        self.fsm_core.update_task_state(
            task_id, "BLOCKED", "Agent-5", "Task blocked"
        )
...
class TestIntegrationEndToEnd(unittest.TestCase):
    ...
    def test_full_workflow(self):
        ...
        try:
            ...
            # Complete task
            fsm_core.update_task_state(
                task1_id, "COMPLETED", "Agent-1", "Task completed",
