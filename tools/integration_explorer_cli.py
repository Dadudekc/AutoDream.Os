...
class IntegrationExplorerCLI:
    ...
    def explore_integrations(self, target_path: str) -> bool:
        ...
        try:
            ...
            print("✅ Integration exploration completed!")
            print(
                f"🔌 API endpoints discovered: {exploration_result['discoveries']['api_endpoints']}"
            )
            print(
                f"🔗 Service connections found: {exploration_result['discoveries']['service_connections']}"
            )
            print(
                f"🗄️ Database integrations: {exploration_result['discoveries']['database_integrations']}"
            )
            ...
            print("\n📊 Integration Health:")
            print(
                f"  ✅ Healthy: {exploration_result['integration_health']['healthy_integrations']}"
            )
            print(
                f"  ⚠️ Degraded: {exploration_result['integration_health']['degraded_integrations']}"
            )
