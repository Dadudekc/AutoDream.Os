"""
Agent Communication System - Compatibility Layer
...
from .communication_compatibility_layer import (
    ...
    # Classes
    AgentCommunicationProtocol, InboxManager,
    # Dataclasses
    Message, AgentInfo,
    # Functions
    create_message, create_agent_info
)

# Re-export for backward compatibility
__all__ = [
    'MessageType', 'MessagePriority', 'MessageStatus', 'AgentStatus', 'AgentCapability',
    'AgentCommunicationProtocol', 'InboxManager', 'Message', 'AgentInfo',
    'create_message', 'create_agent_info'
]
...
import warnings
warnings.warn(
    "agent_communication.py is deprecated. Use v2_comprehensive_messaging_system directly.",
    DeprecationWarning,
    stacklevel=2
)
