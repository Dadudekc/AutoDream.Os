...
def set_8_agent_coordinates():
    ...
    print(
        "│  │   AGENT-1   │  │   AGENT-2   │  │   AGENT-5   │  │   AGENT-7   │                      │"
    )
    print(
        "│  │ Foundation  │  │ AI & ML     │  │ Business    │  │ Web Dev     │                      │"
    )
    print(
        "│  │ & Testing   │  │ Integration │  │ Intelligence│  │ & UI       │                      │"
    )
    print(
        "│  │             │  │             │  │ & Trading   │  │ Framework  │                      │"
    )
    print(
        "│  │ (0,0,800,600)│  │(800,0,800,600)│  │(1600,0,800,600)│  │(2400,0,800,600)│                      │"
    )
    print(
        "│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────┘                      │"
    )
    ...
    print(
        "│  │   AGENT-3   │  │   AGENT-4   │  │   AGENT-6   │  │   AGENT-8   │                      │"
    )
    print(
        "│  │ Multimedia  │  │ Security &  │  │ Gaming &    │  │ Integration │                      │"
    )
    print(
        "│  │ & Content   │  │ Infrastructure│  │ Entertainment│  │ & Performance│                      │"
    )
    print(
        "│  │             │  │             │  │             │  │ Optimization│                      │"
    )
    print(
        "│  │(0,600,800,600)│  │(800,600,800,600)│  │(1600,600,800,600)│  │(2400,600,800,600)│                      │"
    )
    print(
        "│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────┘                      │"
    )
    ...
    for agent_id, info in agent_regions.items():
        try:
            ...
            print(
                f"   {info['color']} Moving to {agent_id} center: ({center_x}, {center_y})"
            )
