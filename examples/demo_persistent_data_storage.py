...
def main():
    ...
    storage.store_data("agent_status_current", agent_status_data, "status", DataIntegrityLevel.ADVANCED)
    ...
    print(f"📊 Mission data integrity: {'✅ PASSED' if mission_check.passed else '❌ FAILED'}")
    ...
    print(f"📊 Agent status integrity: {'✅ PASSED' if status_check.passed else '❌ FAILED'}")
    ...
    # Store modified data
    storage.store_data("mission_001", modified_mission, "missions", DataIntegrityLevel.CRITICAL)
    ...
    print(f"📊 Modified data integrity: {'✅ PASSED' if modified_check.passed else '❌ FAILED'}")
    ...
    for i in range(10):
        ...
        storage.store_data(f"perf_test_{i}", test_data, "tests", DataIntegrityLevel.BASIC)
