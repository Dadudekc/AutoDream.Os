...
def test_contract_generation():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for contract in contracts:
            ...
            ), f"Contract file {contract.contract_id}.json should exist"
...
def test_contract_completion_flow():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert (
            len(contract_files) == 2
        ), "Should generate 2 new contracts per completion"
...
def test_status_reporting():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        assert (
            "auto_generation" in status
        ), "Status should include auto-generation setting"
