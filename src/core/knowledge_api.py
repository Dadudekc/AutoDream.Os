...
class KnowledgeAPI:
    ...
    def add_knowledge(self, title: str, content: str, category: str, 
                      ...
                      source: str = "agent_api", confidence: float = 0.8,
    ...
    def get_knowledge_by_category(self, category: str, limit: int = 50) -> List[Dict[str, Any]]:
        """
    ...
    def get_knowledge_by_agent(self, agent_id: str, limit: int = 50) -> List[Dict[str, Any]]:
        """
    ...
    def add_learning_experience(self, agent_id: str, task_description: str, 
                               outcome: str, lessons_learned: str,
                               success_rate: float = 0.5, 
                               category: str = "learning_experience") -> Optional[str]:
        """
...
Success Rate: {success_rate:.2f}
    ...
    def add_best_practice(self, agent_id: str, practice_name: str, 
                         description: str, when_to_use: str,
                         examples: Optional[List[str]] = None,
                         category: str = "best_practices") -> Optional[str]:
        """
...
When to Use: {when_to_use}{examples_text}
    ...
    def add_troubleshooting_guide(self, agent_id: str, problem: str, 
                                 solution: str, steps: List[str],
                                 prevention_tips: Optional[List[str]] = None,
                                 category: str = "troubleshooting") -> Optional[str]:
        """
...
{steps_text}{prevention_text}
    ...
    def get_recommendations(self, agent_id: str, context: str, 
...
def quick_add(title: str, content: str, category: str, agent_id: str, **kwargs) -> Optional[str]:
