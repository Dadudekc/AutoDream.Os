    ...
    def check_acknowledgement_loop(self, agent_id: str, message_history: List[Dict]) -> bool:
        ...
        for msg in recent_messages:
            ...
            if any(phrase in content for phrase in [
                'acknowledged', 'received', 'understood', 'noted', 
                'will review', 'will process', 'will analyze',
                'thank you', 'message received', 'status updated'
            ]):
                ack_count += 1
...
def break_acknowledgement_loop(agent_id: str, task_id: str, action_type: ActionType) -> Dict[str, Any]:
