...
def main():
    ...
    logger.info(f"Performance Data Points: {analytics_result['performance_data_points']}")
    logger.info(f"Active Alerts: {analytics_result['active_alerts']}")
    logger.info(f"Recommendations: {len(analytics_result['recent_recommendations'])}")
    logger.info("")
