...
def main():
    ...
    parser.add_argument(
        "--output", default="project_analysis.json", help="Output file for analysis results"
    )
    ...
    try:
        ...
        if args.format == "json":
            ...
            if "python_analysis" in analysis:
                ...
                print(
                    f"📊 Compliance rate: {python_analysis['v2_compliant_files']/python_analysis['total_python_files']*100:.1f}%"
                )
