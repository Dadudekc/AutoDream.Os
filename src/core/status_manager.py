...
class StatusManager:
            ...
            for agent_id, agent_info in current_agents.items():
                ...
                if previous_status and previous_status != current_status:
                    ...
                    self._handle_status_change(
                        agent_id, previous_status, current_status
                    )
    ...
    def _update_previous_status(self, agent_id: str, status: AgentStatus):
        ...
        try:
            ...
            with open(status_file, "w") as f:
                json.dump(
                    {"status": status.value, "timestamp": datetime.now().isoformat()}, f
                )
    ...
    def _determine_transition(
        ...
        try:
            if old_status == AgentStatus.ONLINE and new_status == AgentStatus.OFFLINE:
                ...
                old_status == AgentStatus.HEALTHY and new_status == AgentStatus.WARNING
            ):
                return StatusTransition.HEALTHY_TO_WARNING
            elif (
                old_status == AgentStatus.WARNING and new_status == AgentStatus.CRITICAL
            ):
    ...
    def register_status_callback(
        self, agent_id: str, callback: Callable[[StatusEvent], None]
    ):
