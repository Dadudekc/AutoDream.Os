    ...
    def run_integration_tests(self) -> dict[str, Any]:
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                logger.info(
                    f"Integration tests completed: {test_results['tests_passed']}/{test_results['tests_run']} passed"
                )
                return test_results
    ...
    def _test_database_connectivity(self, cursor) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                if result[0] == 1
                else "Database connectivity test failed",
            }
        except Exception as e:
            return {
                "test_name": "database_connectivity",
    ...
    def _test_data_integrity(self, cursor) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                else f"Data integrity issues: {integrity_issues}",
                "details": {
                    # SECURITY: Key placeholder - replace with environment variable
    ...
    def _test_performance(self, cursor) -> dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "message": f"Performance test passed (query time: {query_time:.3f}s)"
                if performance_ok
                else f"Performance test failed (query time: {query_time:.3f}s)",
                "details": {
