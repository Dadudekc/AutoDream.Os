...
class ChartWidget(QWidget):
    ...
    def draw_no_data_message(self, painter):
        ...
        painter.drawText(self.chart_area.rect(), Qt.AlignCenter, "No chart data available")
    ...
    def refresh_chart(self):
        """Refresh chart data"""
        self.chart_updated.emit({"chart_type": self.chart_type, "timeframe": self.timeframe})
