...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Project Update Messaging System CLI"
    )
    
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Dry run mode - don't actually send messages"
    )
    ...
    milestone_parser.add_argument("--completion", type=int, required=True, help="Completion percentage")
...
def parse_agents(agents_str: Optional[str]) -> Optional[List[str]]:
