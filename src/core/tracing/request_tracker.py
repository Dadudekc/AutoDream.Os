...
class RequestTracker:
    ...
    def start_request(self, method: str, path: str, headers: Dict[str, str] = None,
    ...
    def complete_request(self, request_id: str, status: RequestStatus = RequestStatus.COMPLETED,
                        error_message: str = None) -> bool:
