...
class TestMarketSentimentPortfolioOptimizationIntegration:
    ...
    def setup_teardown(self):
        ...
        self.market_sentiment_service = MarketSentimentService(
            data_dir=str(self.sentiment_dir)
        )
        self.portfolio_optimization_service = PortfolioOptimizationService(
            data_dir=str(self.optimization_dir)
        )
    ...
    def test_text_sentiment_analysis(self):
        ...
        score, confidence = self.market_sentiment_service.analyze_text_sentiment(
            bullish_text
        )
        ...
        # Test bearish text
        bearish_text = (
            "The company missed earnings estimates and reported declining revenue."
        )
        score, confidence = self.market_sentiment_service.analyze_text_sentiment(
            bearish_text
        )
        ...
        # Test neutral text
        neutral_text = (
            "The company reported quarterly results in line with expectations."
        )
        score, confidence = self.market_sentiment_service.analyze_text_sentiment(
            neutral_text
        )
    ...
    def test_news_sentiment_analysis(self):
        ...
        # Analyze sentiment
        sentiment_data = self.market_sentiment_service.analyze_news_sentiment(
            test_articles
        )
    ...
    def test_social_media_sentiment_analysis(self):
        ...
        # Analyze sentiment
        sentiment_data = self.market_sentiment_service.analyze_social_media_sentiment(
            social_data
        )
    ...
    def test_analyst_ratings_sentiment_analysis(self):
        ...
        # Analyze sentiment
        sentiment_data = self.market_sentiment_service.analyze_analyst_ratings(
            ratings_data
        )
    ...
    def test_options_flow_sentiment_analysis(self):
        ...
        # Analyze sentiment
        sentiment_data = self.market_sentiment_service.analyze_options_flow_sentiment(
            options_data
        )
    ...
    def test_portfolio_allocation_analysis(self):
        ...
        for symbol, allocation in allocations.items():
            ...
            assert allocation.market_cap in [
                "LARGE_CAP",
                "MID_CAP",
                "SMALL_CAP",
                "MICRO_CAP",
    ...
    def test_optimization_recommendations(self):
        ...
        # Get recommendations
        recommendations = (
            self.portfolio_optimization_service.get_optimization_recommendations(
                optimization_result
            )
        )
    ...
    def test_integration_workflow(self):
        ...
        rebalancing_signals = (
            self.portfolio_optimization_service.generate_rebalancing_signals(
                current_portfolio, target_weights
            )
        )
    ...
    def test_error_handling(self):
        ...
        empty_signals = self.market_sentiment_service.get_sentiment_signals(
            "NONEXISTENT"
        )
        ...
        empty_allocations = (
            self.portfolio_optimization_service.analyze_portfolio_allocation([], {})
        )
