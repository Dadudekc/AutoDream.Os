...
class ErrorOrchestrator:
    ...
    def handle_error(self, error: ErrorInfo, context: ErrorContext) -> Optional[RecoveryAction]:
...
def create_error_handler(handler_type: str, handler_id: str = None) -> Optional[ErrorHandler]:
...
def create_error_recovery(recovery_type: str, recovery_id: str = None) -> Optional[ErrorRecovery]:
