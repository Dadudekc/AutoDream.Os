...
try:
    from src.services.consolidated_miscellaneous_service import Consolidated_Miscellaneous_Service
except ImportError:
    # If direct import fails, try from parent module
    from src.services import Consolidated_Miscellaneous_Service
