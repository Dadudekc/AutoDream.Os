...
Examples:
  ...
  %(prog)s --test                    # Test all functionality
        ...
        parser.add_argument("--init", action="store_true", 
                          help="Initialize all 5 agents")
        parser.add_argument("--status", action="store_true", 
                          help="Get status of all agents")
        parser.add_argument("--shutdown", action="store_true", 
                          help="Shutdown all agents gracefully")
        
        # Mode operations
        parser.add_argument("--mode", choices=["onboarding", "coordination", "autonomous", "cleanup"],
        ...
        parser.add_argument("--test", action="store_true",
                          help="Test all launcher functionality")
    ...
    def run(self, args=None):
        ...
        if any([args.check, args.init, args.mode, args.status, args.shutdown, args.test]):
            self.print_banner()
