...
class AgentHealthMonitor:
            ...
            if status_file_exists:
                try:
                    ...
                    if isinstance(status_data, dict) and (
                        "last_update" in status_data or "last_updated" in status_data
                    ):
                        status_file_valid = True

                        # Calculate age of last update
                        last_update_str = status_data.get(
                        ...
                        if last_update_str:
                            try:
                                ...
                                if (
                                    last_update_time.tzinfo is not None
                                    ...
                                    last_update_time.tzinfo is None
    ...
    def get_health_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "error_agents": status_counts["missing_workspace"]
            + status_counts["missing_status"]
...
def main():
    ...
    parser.add_argument(
        "--history", nargs=2, metavar=("AGENT", "HOURS"), help="Get health history for agent"
    )
