...
class APIGateway:
    ...
    def register_service(self, service_id: str, name: str, version: str, 
                        base_url: str, health_check_url: str = None,
    ...
    def set_rate_limit(self, service_id: str, requests_per_minute: int, 
        ...
        with self.lock:
            ...
            logger.info(f"Rate limit set for {service_id}: {requests_per_minute} req/min")
    
    def route_request(self, method: str, path: str, headers: Dict[str, str] = None,
                     query_params: Dict[str, str] = None, body: Any = None,
                     client_ip: str = "unknown", user_agent: str = "unknown") -> APIResponse:
        ...
        if self.performance_tracker:
            self.performance_tracker.record_metric(
                'api_response_time', processing_time, 'seconds', None,
    ...
    def _check_rate_limit(self, service_id: str) -> bool:
        ...
        # Check current count
        current_count = rate_limit['request_counts'][current_time.strftime('%Y-%m-%d %H:%M')]
    ...
    def _forward_request(self, request: APIRequest, target_url: str, 
                        service_id: str) -> APIResponse:
    ...
    def _create_error_response(self, request_id: str, status_code: int, 
                              error_message: str, service_id: str = None) -> APIResponse:
    ...
    def _perform_health_checks(self):
        ...
        for service_id, service in list(self.registered_services.items()):
            try:
                ...
                if (current_time - service.last_health_check).total_seconds() > self.health_check_interval:
                    ...
                    if service.status != new_status:
                        ...
                        logger.info(f"Service {service_id} health status: {new_status.value}")
