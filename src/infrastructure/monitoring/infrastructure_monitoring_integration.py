...
from .components.monitoring_components import MonitoringComponents, InfrastructureHealthMetrics
...
try:
    ...
    class HealthMetric:
        def __init__(self, name: str, value: Any, unit: str = "", timestamp: Optional[datetime] = None):
            self.name = name
            self.value = value
            self.unit = unit
...
class InfrastructureMonitoringIntegration:
    ...
    def __init__(self, health_service: Optional[HealthMonitoringService] = None):
        ...
        self.last_health_snapshot: Optional[SystemHealthSnapshot] = None
    ...
    def _update_health_service(self, infrastructure_status: Dict[str, Any], 
    ...
    def _add_infrastructure_metrics(self, snapshot: SystemHealthSnapshot, 
    ...
    def record_operation_metrics(self, operation: str, response_time: float, 
