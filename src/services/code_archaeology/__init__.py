...
class CodeArchaeologyService:
    ...
    def conduct_archaeological_dig(
        self, target_path: str, analysis_depth: str = "comprehensive"
    ) -> dict:
...
def get_archaeology_tools() -> dict:
    ...
    return {
        ...
        "core_tools": ["GitArchaeologist", "PatternDiscoverer", "DebtMapper", "EvolutionTracker"],
