...
Onboarding Status: {'✅ COMPLETE' if is_onboarded else '❌ PENDING'}
Cycle: #{self.cycle_count + 1}

📋 CURRENT STATUS:
• State: {current_state.value}
• Onboarded: {is_onboarded}
• Transitions: {fsm.transition_count if fsm else 0}
• Previous State: {fsm.previous_state.value if fsm and fsm.previous_state else 'None'}
...
• Onboarding Status: {'Active and integrated' if is_onboarded else 'Pending completion'}
