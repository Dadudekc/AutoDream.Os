...
class ProjectTracker:
    ...
    def get_milestone(self, name: str) -> ProjectMilestone | None:
        """Get a milestone."""
        for milestone in self._milestones:
    ...
    def get_phase_status(self, phase: ProjectPhase) -> ProjectCompletionStatus | None:
        """Get phase status."""
...
class ProjectCompletionManager:
    ...
    def get_next_phase(self) -> ProjectPhase | None:
