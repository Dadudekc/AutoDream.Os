...
class TestIntelligentPromptGenerator(unittest.TestCase):
    ...
    def test_agent_specializations_initialization(self):
        ...
        expected_agents = [
            "code_reviewer", "documentation_expert", "testing_specialist",
            "performance_analyst", "security_expert"
        ]
        ...
        for agent_type in expected_agents:
            ...
            self.assertIn("prompt_template", self.generator.agent_specializations[agent_type])
            self.assertIn("focus_areas", self.generator.agent_specializations[agent_type])
    ...
    def test_prompt_template_filling(self):
        ...
        self.assertIn("Python function definition with low complexity", prompt.intelligent_prompt)
    ...
    def test_confidence_calculation(self):
        ...
        prompt_low = self.generator.generate_intelligent_prompt(self.sample_improvement, context_low)
        
        # Test high complexity (should decrease confidence)
        context_high = {"complexity": "high"}
        prompt_high = self.generator.generate_intelligent_prompt(self.sample_improvement, context_high)
    ...
    def test_expected_outcome_definition(self):
        ...
        prompt = self.generator.generate_intelligent_prompt(improvement, self.sample_context)
...
class TestAutonomousDevelopmentEngine(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.core.autonomous_development.PYAUTOGUI_AVAILABLE', True):
            with patch('src.core.autonomous_development.PerpetualMotionEngine', return_value=self.mock_perpetual_motion):
                with patch('src.core.autonomous_development.CursorResponseCapture', return_value=self.mock_cursor_capture):
    ...
    def test_autonomous_triggers_setup(self):
        ...
        self.mock_perpetual_motion.register_agent_activation.assert_has_calls(expected_calls, any_order=True)
    ...
    def test_development_action_execution(self):
        ...
        context = {"language": "python", "complexity": "medium"}
        cursor_agent_prompt = self.engine.prompt_generator.generate_intelligent_prompt(improvement, context)
    ...
    def test_action_priority_ordering(self):
        ...
        # Execute actions
        with patch.object(self.engine, '_execute_intelligent_code_generation_action') as mock_execute:
            self.engine._execute_development_actions()
    ...
    def test_conversation_generation(self):
        ...
        with patch.object(self.engine, '_generate_intelligent_conversation') as mock_generate:
            self.engine._execute_autonomous_cycle()
