#!/usr/bin/env python3
"""
Unified Browser Service - Main Interface
=========================================

Main interface for unified browser service system.
...
from .browser_service_models import BrowserConfig, TheaConfig, BrowserStatus
from .browser_adapter import BrowserAdapter, ChromeBrowserAdapter, create_chrome_adapter
from .cookie_manager import CookieManager, create_cookie_manager
from .session_manager import SessionManager, create_session_manager
from .browser_operations import BrowserOperations, create_browser_operations


class UnifiedBrowserService:
    """Unified browser service combining all components."""

    def __init__(self, browser_config: BrowserConfig, thea_config: TheaConfig):
        """Initialize unified browser service."""
        self.browser_config = browser_config
        self.thea_config = thea_config

        # Initialize components
        self.browser_adapter: BrowserAdapter = create_chrome_adapter()
        self.cookie_manager = create_cookie_manager(thea_config.cookie_file, thea_config.auto_save_cookies)
        self.session_manager = create_session_manager(thea_config)
        self.operations = create_browser_operations(self.browser_adapter, thea_config)
...
__all__ = [
    ...
    "create_chrome_adapter",
    "create_cookie_manager",
    "create_session_manager",
    "create_browser_operations",
]
