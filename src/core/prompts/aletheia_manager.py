...
class AletheiaPromptManager:
    ...
    def generate_prompt(
        self, template_name: str, context: dict[str, Any], memory_key: str | None = None
    ) -> str:
        ...
        try:
            ...
            # Add timestamp
            prompt_context["timestamp"] = datetime.now(UTC).isoformat()
    ...
    def clear_memory(self, key: str | None = None) -> None:
        """Clear memory cache."""
        with self._lock:
            if key:
...
def generate_prompt(
    template_name: str, context: dict[str, Any], memory_key: str | None = None
) -> str:
...
def get_template_content(template_name: str) -> str | None:
    """Get template content."""
...
def clear_memory(key: str | None = None) -> None:
    """Clear memory cache."""
