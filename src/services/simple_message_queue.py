...
class MessageQueue:
    ...
    def enqueue(self, message: Message) -> bool:
        ...
        try:
            ...
            priority_score = (
                MessagePriority.CRITICAL.value - message.priority.value,
                time.time(),
            )
            ...
            logger.info(
                f"Message {message.id} queued with priority {message.priority.name}"
            )
            return True
...
class SimpleMessageQueueSystem:
    ...
    def _send_message(self, message: Message):
        ...
        try:
            ...
            logger.info(
                f"Message {message.id} sent successfully to {message.recipient}"
            )
