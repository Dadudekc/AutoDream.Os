...
class PerformanceProfiler:
    ...
    def end_profile(self, profile_id: str) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            self._record_profile_metric(profile['name'], duration, 'seconds', 
                                      profile['context'], ['profile_completion'])
    ...
    def profile_function(self, profile_name: str = None):
        ...
        def decorator(func):
            ...
            def wrapper(*args, **kwargs):
                ...
                with self.profile(name, {'function': func.__name__, 'args_count': len(args)}):
    ...
    def get_profiling_summary(self, time_range: Optional[timedelta] = None) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            if time_range:
                ...
                metrics_to_analyze = [m for m in metrics_to_analyze if m.timestamp >= cutoff_time]
    ...
    def _record_profile_metric(self, name: str, value: float, unit: str,
    ...
    def export_profiling_data(self, filepath: str, time_range: Optional[timedelta] = None):
        ...
        with self.lock:
            ...
            logger.info(f"Exported {len(export_data['metrics'])} profiling metrics to {filepath}")
