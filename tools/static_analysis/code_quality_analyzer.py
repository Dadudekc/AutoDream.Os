...
class CodeQualityAnalyzer:
    ...
    def _run_ruff_analysis(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "data": ruff_data, "command": " ".join(cmd)}
    ...
    def _run_pylint_analysis(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "data": pylint_data, "command": " ".join(cmd)}
    ...
    def _run_mypy_analysis(self) -> dict[str, Any]:
        ...
        try:
            cmd = ["mypy", "--json-report", "/tmp/mypy-report.json", str(self.project_root / "src")]
            result = subprocess.run(cmd, capture_output=True, text=True, cwd=self.project_root)

            mypy_data = []
            try:
                with open("/tmp/mypy-report.json") as f:
                    mypy_data = json.load(f)
            except FileNotFoundError:
                mypy_data = [{"raw_output": result.stdout}]

            return {"status": "success", "data": mypy_data, "command": " ".join(cmd)}
    ...
    def _run_flake8_analysis(self) -> dict[str, Any]:
        ...
        try:
            ...
            return {"status": "success", "data": flake8_data, "command": " ".join(cmd)}
    ...
    def _run_complexity_analysis(self) -> dict[str, Any]:
        ...
        try:
            ...
            cmd = ["radon", "cc", "--json", "--min", "B", str(self.project_root / "src")]
            result = subprocess.run(cmd, capture_output=True, text=True, cwd=self.project_root)
            ...
            return {"status": "success", "data": complexity_data, "command": " ".join(cmd)}

        except (subprocess.CalledProcessError, FileNotFoundError):
            logger.warning("Radon not available, skipping complexity analysis...")
            return {"status": "skipped", "reason": "Radon not installed", "data": []}
        except Exception as e:
    ...
    def _generate_violation_summary(self, tools_results: dict[str, Any]) -> dict[str, Any]:
        ...
        summary = {
            ...
            "by_category": {"style": 0, "type": 0, "complexity": 0, "security": 0},
        }
