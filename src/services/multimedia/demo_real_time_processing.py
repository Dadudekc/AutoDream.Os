...
class RealTimeMediaDemo:
    ...
    def run_webcam_filter_demo(self):
        ...
        try:
            ...
            # Start pipeline
            if self.media_processor.start_multimedia_pipeline('webcam_filter_demo', pipeline_config):
    ...
    def run_audio_processing_demo(self):
        ...
        try:
            ...
            # Start pipeline
            if self.media_processor.start_multimedia_pipeline('audio_processing_demo', pipeline_config):
    ...
    def run_content_generation_demo(self):
        ...
        try:
            ...
            # Create pipeline
            if self.content_manager.create_content_pipeline('demo_blog_pipeline', pipeline_config):
                ...
                if self.content_manager.start_content_generation('demo_blog_pipeline', source_data):
                    ...
                    # Check results
                    status = self.content_manager.get_pipeline_status('demo_blog_pipeline')
                    ...
                    if cache['total_cached'] > 0:
                        ...
                        logger.info(f"Quality Score: {recent_content.get('processing_info', {}).get('quality_score', 'N/A')}")
                    else:
    ...
    def run_content_scheduling_demo(self):
        ...
        try:
            ...
            # Create schedule
            if self.streaming_service.schedule_content('demo_daily_schedule', schedule_config):
                logger.info("✅ Daily content schedule created successfully")
                
                # Check schedule status
                status = self.streaming_service.get_schedule_status('demo_daily_schedule')
                ...
                if self.streaming_service.schedule_content('demo_weekly_schedule', weekly_config):
