...
class AgentOnboardingHandler:
    ...
    async def handle_agent_onboarding(self, interaction, agent_id):
        ...
        back_btn = discord.ui.Button(
            label="⬅️ Back to Agent", style=discord.ButtonStyle.secondary, custom_id="back_to_agent"
        )
    ...
    async def handle_team_selection(self, interaction, agent_id, team_name):
        ...
        cancel_btn = discord.ui.Button(
            label="❌ Cancel", style=discord.ButtonStyle.danger, custom_id="cancel_onboard"
        )
    ...
    async def execute_agent_onboarding(self, interaction, agent_id, team_name):
        ...
        try:
            ...
            error_embed.add_field(
                name="🔍 **Error Details**",
                value="An error occurred during the onboarding process. Please try again or contact support.",
                inline=False,
            )
