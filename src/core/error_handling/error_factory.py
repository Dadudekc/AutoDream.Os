...
class ErrorHandlerFactory:
    ...
    def get_handler(self, error_type: ErrorType) -> Optional[BaseErrorHandler]:
    ...
    def create_handler(self, error_type: ErrorType, handler_class: Type[BaseErrorHandler]) -> BaseErrorHandler:
    ...
    def _create_generic_error_details(self, error: Exception, context: ErrorContext) -> ErrorDetails:
