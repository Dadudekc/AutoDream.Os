...
class TheaConfig:
    ...
    # Core URLs
    thea_url: str = (
        "https://chatgpt.com/g/g-67f437d96d7c81918b2dbc12f0423867-thea-manager?model=gpt-5-thinking"
    )
    ...
    # Message templates
    message_template_path: Path = field(
        default_factory=lambda: Path("messages/thea_consultation_message.md")
    )

    # Selenium options
    selenium_options: dict[str, Any] = field(
