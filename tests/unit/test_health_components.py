...
class TestHealthAlertManager:
    ...
    def test_filter_alerts(self):
        ...
        manager.create_alert("agent_1", "warning", "Warning alert", "metric_1", 100.0, 50.0)
        manager.create_alert("agent_1", "critical", "Critical alert", "metric_2", 200.0, 100.0)
        manager.create_alert("agent_2", "warning", "Another warning", "metric_3", 150.0, 75.0)
    ...
    def test_acknowledge_alert(self):
        ...
        alert = manager.create_alert("test_agent", "warning", "Test alert", "metric", 100.0, 50.0)
