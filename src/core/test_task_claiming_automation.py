...
from src.core.task_claiming_automation import Task, TaskClaimingAutomation
...
def test_task_claiming_with_temp_files():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            working_tasks = {"current_task": None, "previous_task": None, "completed_tasks": []}
...
def main():
    ...
    # Run tests
    test_results.append(
        ("Task Claiming Automation Initialization", test_task_claiming_automation_initialization())
    )
    test_results.append(("Task Class Functionality", test_task_class()))
    test_results.append(
        ("Task Claiming with Temporary Files", test_task_claiming_with_temp_files())
    )
