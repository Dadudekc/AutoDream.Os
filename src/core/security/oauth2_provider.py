...
class OAuth2Provider:
    ...
    def _generate_access_token(self, client_id: str, user_id: str, scope: str) -> AccessToken:
        ...
        access_token = AccessToken(token=token, expires_in=3600, scope=scope)
    ...
    def get_client_info(self, client_id: str) -> OAuth2Client | None:
