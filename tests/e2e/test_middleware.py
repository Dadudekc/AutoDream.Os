...
try:
    from src.web.vector_database.middleware import Middleware import
except ImportError:
    # If direct import fails, try from parent module"
    from src.web.vector_database import Middleware import""
"""
""""
...
""""
    def test_initialization(self):":"":""
        ...
        assert isinstance(self.instance, Middleware)"""
""""
