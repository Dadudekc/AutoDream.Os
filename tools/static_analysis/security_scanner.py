...
class SecurityScanner:
    ...
    def _run_semgrep_scan(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                '--exclude-rule', 'python.lang.security.audit.weak-cryptographic-key.weak-cryptographic-key',
    ...
    def _run_dependency_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if not requirements_file.exists():
                return {
                    'status': 'skipped',
                    'reason': 'No requirements.txt found',
                    'data': []
                }
    ...
    def _generate_security_summary(self, tools_results: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if summary['high_severity'] > 0:
            summary['recommendations'].append("🚨 CRITICAL: Address high-severity security issues immediately")
        
        if summary['medium_severity'] > 5:
            summary['recommendations'].append("⚠️  WARNING: Multiple medium-severity issues detected")
