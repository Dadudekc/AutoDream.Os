...
class OperationsManager:
    ...
    async def update_operations_with_results(self, operations: List[Dict[str, Any]], results: List[Dict[str, Any]]) -> None:
    ...
    def enable_operation(self, operation_name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"{self.core.agent_id}: Failed to enable operation '{operation_name}': {e}")
            return False
    ...
    def disable_operation(self, operation_name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"{self.core.agent_id}: Failed to disable operation '{operation_name}': {e}")
            return False
