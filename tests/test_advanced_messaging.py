...
from core.messaging.message_types import Message, MessagePriority, MessageType, MessageStatus
...
async def test_in_memory_queue():
    ...
    if message:
        print(f"✅ Dequeued for Agent-2: {message.content} (Priority: {message.priority.value})")
