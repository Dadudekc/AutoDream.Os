...
class ConfigurationValidator:
    ...
    def _validate_config_structure(
        self, file_path: Path, errors: list[str], warnings: list[str]
    ) -> None:
    ...
    def _validate_coordinates_config(
        self, file_path: Path, errors: list[str], warnings: list[str]
    ) -> None:
                ...
                for agent_id, agent_config in agents.items():
                    ...
                    for field in required_fields:
                        if field not in agent_config:
                            ...
                            not isinstance(agent_config[field], list)
                            or len(agent_config[field]) != 2
                        ):
                            errors.append(
    ...
    def _validate_messaging_config(
        self, file_path: Path, errors: list[str], warnings: list[str]
    ) -> None:
    ...
    def generate_validation_report(
        self, output_file: str = "runtime/reports/config_validation_report.json"
    ) -> str:
...
def main():
    ...
    parser.add_argument(
        "--output",
        default="runtime/reports/config_validation_report.json",
