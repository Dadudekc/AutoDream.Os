...
class PerformanceTracker:
    ...
    def record_metric(self, metric_type: MetricType, value: float, 
                     agent_id: Optional[str] = None, context: Dict[str, Any] = None,
    ...
    def get_latest_metric(self, metric_type: MetricType, 
                         agent_id: Optional[str] = None) -> Optional[PerformanceMetric]:
            ...
            for agent_id, agent_metrics_list in self.agent_metrics.items():
                if agent_metrics_list:
                    ...
                    for metric in agent_metrics_list[-100:]:  # Last 100 per agent
                        agent_metrics_by_type[metric.metric_type.value].append(metric.value)
