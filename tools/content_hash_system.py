...
class ContentHashSystem:
    ...
    def check_duplicate(self, content: str, metadata: Dict = None, db_type: str = "swarm_brain") -> bool:
    ...
    def add_content_hash(self, content: str, metadata: Dict = None, db_type: str = "swarm_brain", doc_id: str = None):
        ...
        if vector_file.exists():
            ...
            for vector in vectors:
                try:
                    ...
                    self.add_content_hash(content, metadata, "vector_database", vector.get('id', ''))
                    vector_hashes += 1
                except Exception as e:
    ...
    def get_duplicate_report(self) -> Dict[str, Any]:
        ...
        report = {
            "total_hashes": sum(len(hashes) for hashes in self.content_hashes.values() if isinstance(hashes, dict)),
            "database_stats": {},
