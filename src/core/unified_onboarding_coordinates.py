...
class UnifiedOnboardingCoordinates:
    ...
    def get_input_coordinates(self, agent_id: str) -> tuple[int, int] | None:
    ...
    def get_agent_coordinates(self, agent_id: str) -> dict[str, int] | None:
...
def get_onboarding_coordinates(agent_id: str) -> tuple[int, int] | None:
