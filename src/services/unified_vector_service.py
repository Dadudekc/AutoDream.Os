...
class InMemoryVectorRepository(VectorRepository):
    ...
    def search_documents(self, query: SearchQuery) -> List[SearchResult]:
        ...
        try:
            ...
            candidates = [self.documents[doc_id] for doc_id in collection_docs 
...
class UnifiedVectorService:
    ...
    def store_message(self, content: str, agent_id: str, message_type: str = "message",
    ...
    def search_messages(self, query: str, agent_id: Optional[str] = None,
