...
class ConfigUtilsCoordinator:
    ...
    def load_config_with_overrides(self) -> Dict[str, Any]:
        ...
        try:
            ...
            updated_config = self.environment_overrides.apply_environment_overrides(config_data)
    ...
    def get_config_status(self) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                "sections": self.config_loader.list_config_sections() if self.config_loader.is_loaded() else [],
...
def main():
    ...
    parser.add_argument("--env-summary", action="store_true", help="Show environment overrides summary")
