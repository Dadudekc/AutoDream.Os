#!/usr/bin/env python3
"""
🔄 UNIFIED SERVICE WRAPPER - Debate
==================================================

This file replaces the original consolidated_debate_service.py with a wrapper
that uses the unified service management system.

Original file: /workspace/src/services/consolidated_debate_service.py
Service type: debate
Migration date: 2025-09-14T20:16:40.494063
...
def main():
    ...
    try:
        ...
        service_type = ServiceType.DEBATE
        ...
        print(f"Error running debate service: {e}")
        sys.exit(1)
