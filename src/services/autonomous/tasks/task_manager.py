...
class TaskManager:
    ...
    def _select_task_to_claim(self, available_tasks: list[dict[str, Any]]) -> dict[str, Any] | None:
    ...
    def _get_priority_score(self, priority: str) -> int:
        ...
        priority_scores = {"critical": 5, "high": 4, "medium": 3, "normal": 2, "low": 1}
        return priority_scores.get(priority.lower(), 2)

    async def _move_task_to_working(
        self, task: dict[str, Any], available_tasks: list[dict[str, Any]]
    ) -> None:
