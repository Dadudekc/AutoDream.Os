...
class WorkspaceStructureManager:
    ...
    def create_workspace_structure(self, workspace_path: Path, workspace_type: WorkspaceType) -> bool:
...
def run_smoke_test():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            success = manager.create_workspace_structure(test_workspace, WorkspaceType.AGENT)
            assert success
