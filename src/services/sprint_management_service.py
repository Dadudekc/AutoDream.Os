...
class SprintManagementService:
    ...
    def create_sprint(self, name: str, description: str, duration_days: int = 14) -> Sprint:
    ...
    def add_task_to_sprint(self, sprint_id: str, task_id: str) -> bool:
        ...
        try:
            ...
            if len(sprint.tasks) >= sprint.max_tasks:
                self.logger.warning(f"Sprint {sprint.name} already has {sprint.max_tasks} tasks")
                return False
    ...
    def start_sprint(self, sprint_id: str) -> bool:
        ...
        try:
            ...
            if sprint.status != SprintStatus.PLANNING:
                self.logger.warning(f"Sprint {sprint.name} cannot be started from {sprint.status}")
                return False
    ...
    def complete_sprint(self, sprint_id: str) -> bool:
        ...
        try:
            ...
            if sprint.status != SprintStatus.ACTIVE:
                self.logger.warning(f"Sprint {sprint.name} cannot be completed from {sprint.status}")
                return False
