...
class MLPipelineManager:
    ...
    def _create_training_data(self, data_config: dict[str, Any]) -> TrainingData | None:
    ...
    def batch_train_models(
        self, models_config: list[dict[str, Any]], shared_data_config: dict[str, Any]
    ) -> dict[str, Any]:
        ...
        try:
            ...
            for model_config in models_config:
                ...
                try:
                    model = self.core.create_model(
                        model_name, model_config.get("type", "neural_network")
                    )
                    training_results = self.core.train_model(
                        model_name,
                        training_data,
    ...
    def export_results(self, output_path: str) -> bool:
        ...
        try:
            ...
            results = {
                ...
                "models": {
                    name: self.core.get_model_info(name) for name in self.core.list_models()
                },
                "metrics": {
                    name: metrics.to_dict() for name, metrics in self.core.model_metrics.items()
                },
            }
