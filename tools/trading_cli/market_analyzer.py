...
from tsla_forecast_app.modules import TradingFlagEngine, AgentFlag
...
class MarketAnalyzer:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                return {
                    ...
                    'change_percent': ((meta['regularMarketPrice'] - meta.get('previousClose', meta['regularMarketPrice'])) / meta.get('previousClose', meta['regularMarketPrice'])) * 100,
    ...
    def _analyze_volatility(self, stock_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'volatility_level': 'high' if change_percent > 5 else 'moderate' if change_percent > 2 else 'low',
