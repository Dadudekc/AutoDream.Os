...
class QualityGatesValidator:
    ...
    def validate(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = subprocess.run([sys.executable, "quality_gates.py", "--path", "src"], 
            ...
            overall_status = quality_gates_working and config_status["precommit_exists"] and config_status["script_exists"]
