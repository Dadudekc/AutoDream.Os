...
Examples:
  ...
  %(prog)s interactive
    ...
    analytics_parser.add_argument('--report', action='store_true', help='Send comprehensive analytics report')
    analytics_parser.add_argument('--new-conversation', action='store_true', help='Start new conversation for report')
    analytics_parser.add_argument('--status', action='store_true', help='Show analytics reporter status')
...
def analytics_command(args):
    ...
    if args.status:
        ...
        success = reporter.send_analytics_report(force_new_conversation=args.new_conversation, visible=False)
