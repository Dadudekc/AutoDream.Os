...
Core deployment verification functionality extracted from test_deployment_verification.py
V2 Compliance: Refactored to ≤400 lines for compliance

Author: Agent-7 (Web Development Specialist)
Test Type: Deployment Verification Core
"""
...
class DeploymentVerificationCore:
    ...
    def _check_environment_variables(self) -> dict[str, Any]:
        ...
        required_vars = [
            "DATABASE_URL", "API_SECRET_KEY", "ENVIRONMENT",
            "LOG_LEVEL", "REDIS_URL", "MESSAGE_QUEUE_URL"
        ]
