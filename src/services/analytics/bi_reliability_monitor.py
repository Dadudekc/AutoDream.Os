...
class BIReliabilityMonitor:
    ...
    def _generate_reliability_recommendations(self, health_summary: Dict[str, Any], 
...
if __name__ == "__main__":
    ...
    monitor.error_tracker.record_error("connection_timeout", "database", "Connection timeout", "high")
    monitor.error_tracker.record_error("memory_overflow", "cache", "Memory limit exceeded", "critical")
