...
from src.core.mailbox_processing_automation import MailboxMessage, MailboxProcessor
...
def main():
    ...
    # Run tests
    test_results.append(
        ("Mailbox Processor Initialization", test_mailbox_processor_initialization())
    )
