...
class PerformanceDashboard:
    ...
    def __init__(self, agent_manager=None, performance_tracker=None, 
                 config_manager=None, message_router=None):
    ...
    def export_dashboard_data(self, filepath: str, time_range: Optional[timedelta] = None):
        ...
        with self.lock:
            ...
            if time_range:
                ...
                snapshots_to_export = [
                    s for s in snapshots_to_export 
                    if s.get('timestamp', datetime.now()) >= cutoff_time
                ]
            
            export_data['performance_snapshots'] = snapshots_to_export[-100:]  # Last 100
        ...
        try:
            ...
            if hasattr(self.agent_manager, 'get_agents'):
                ...
                for agent_id in agents:
                    if self.performance_tracker:
                        agent_summary = self.performance_tracker.get_agent_performance_summary(agent_id)
                        if agent_summary:
