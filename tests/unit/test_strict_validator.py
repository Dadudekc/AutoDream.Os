...
try:
    from src.core.ssot.unified_ssot.validators.strict_validator import Strict_Validator import
except ImportError:
    # If direct import fails, try from parent module"
    from src.core.ssot.unified_ssot.validators import Strict_Validator import""
"""
""""
