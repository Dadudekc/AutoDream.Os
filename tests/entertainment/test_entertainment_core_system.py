...
class TestContentManager(unittest.TestCase):
    ...
    def test_update_content_status(self):
        ...
        # Update status
        success = self.content_manager.update_content_status("status_test_001", ContentStatus.PUBLISHED)
        self.assertTrue(success)
...
class TestEntertainmentCoreSystem(unittest.TestCase):
    ...
    def test_add_content(self):
        ...
        # Verify content was added
        retrieved_content = self.entertainment_system.content_manager.get_content("system_test_001")
        self.assertIsNotNone(retrieved_content)
    ...
    def test_social_media_integration(self):
        ...
        success = self.entertainment_system.post_to_social_media("twitter", content, "Check this out!")
        self.assertTrue(success)
    ...
    def test_user_engagement_tracking(self):
        ...
        # Track engagement
        self.entertainment_system.track_user_engagement("user_001", "engagement_system_test_001", "view")
        self.entertainment_system.track_user_engagement("user_002", "engagement_system_test_001", "like")
        
        # Get analytics
        analytics = self.entertainment_system.get_content_analytics("engagement_system_test_001")
