...
class SwarmMonitoringData:
    ...
    def _init_database(self) -> None:
        ...
        with sqlite3.connect(self.data_path) as conn:
            ...
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_agent_status_agent_id ON agent_status(agent_id)")
            cursor.execute("CREATE INDEX IF NOT EXISTS idx_agent_status_timestamp ON agent_status(timestamp)")
        ...
        try:
            with sqlite3.connect(self.data_path) as conn:
                ...
                for row in cursor.fetchall():
                    ...
                    record['coordination_status'] = json.loads(record['coordination_status'] or '{}')
    ...
    def get_alerts(self, resolved: Optional[bool] = None, hours: int = 24) -> List[Dict[str, Any]]:
