...
class IntentClassifier:
    ...
    def _calculate_intent_confidence(
        self, text: str, patterns: list[str], keywords: list[str]
    ) -> float:
...
class IntentRecognitionSystem:
    ...
    def get_intent_statistics(self) -> dict[str, Any]:
        ...
        return {
            ...
            "average_confidence": sum(r.confidence for r in self.recognition_history)
    ...
    def get_system_status(self) -> dict[str, Any]:
        ...
        return {
            ...
            "total_patterns": sum(
                len(patterns) for patterns in self.classifier.intent_patterns.values()
            ),
