...
from src.core.shared_enums import (
    AgentStatus, AgentCapability, MessageStatus
)
...
class TestV1V2MessageQueueSystem:
    ...
    def setup_method(self):
        ...
        self.mock_config = {
            ...
            "high_priority": {
                "ctrl_enter_threshold": 2,
                "timeout_ms": 5000
            }
        }
        
        # Create message queue system with mocked config
        with patch('src.services.v1_v2_message_queue_system.V1V2MessageQueueSystem._load_config', return_value=self.mock_config):
    ...
    def test_agent_registration(self):
        ...
        assert self.queue_system.agent_connections["test_agent_001"].agent_name == "Test Agent"
    ...
    def test_high_priority_flag_system(self):
        ...
        assert self.queue_system.ctrl_enter_count >= self.queue_system.high_priority_timeout
        
        # Test high-priority mode activation
        with patch.object(self.queue_system, '_process_high_priority_messages') as mock_process:
    ...
    def test_hybrid_delivery_fallback(self):
        ...
        with patch.object(self.queue_system, '_deliver_via_cdp', side_effect=NotImplementedError), \
...
class TestMessageQueueManager:
    ...
    def setup_method(self):
        """Setup test environment before each test."""
        with patch('src.services.v1_v2_message_queue_system.V1V2MessageQueueSystem._load_config', return_value={}):
...
class TestCDPMessageDelivery:
    ...
    def test_cdp_target_creation(self):
        ...
        assert target.web_socket_debugger_url == "ws://localhost:9222/devtools/page/target_001"
    ...
    def test_cursor_target_detection(self):
        ...
        with patch.object(self.cdp_delivery, 'get_targets', return_value=[
            CDPTarget(**target) for target in mock_targets_data
        ]):
            ...
            assert not any("devtools" in target.title.lower() for target in cursor_targets)
