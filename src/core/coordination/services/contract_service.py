...
Service for contract management operations using Service Layer pattern.
...
class ContractService:
    ...
    def create_contract(self, agent_id: str, contract_type: ContractType,
        ...
        """Create new contract for agent."""
        contract = AgentFactory.create_agent_contract(
            agent_id=agent_id,
        ...
        self._add_to_contract_history(contract)
        
        logger.info(f"✅ Created contract {contract.contract_id} for {agent_id}")
        return contract
