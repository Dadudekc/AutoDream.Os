...
from .predictive_models import CapacityForecast, PerformanceMetrics, ResourceUtilization
...
class CapacityForecaster:
    ...
    def forecast_capacity(
        self, resource_type: str, time_horizon: timedelta, metrics_history: list[PerformanceMetrics]
    ) -> CapacityForecast:
    ...
    def get_resource_utilization(
        self, resource_name: str, metrics_history: list[PerformanceMetrics]
    ) -> ResourceUtilization:
    ...
    def _get_recent_metrics(
        self, metrics_history: list[PerformanceMetrics], time_horizon: timedelta
    ...
    def _extract_resource_values(
        self, metrics: list[PerformanceMetrics], resource_type: str
    ) -> list[float]:
    ...
    def _generate_utilization_recommendations(
        self, resource_name: str, current_usage: float, efficiency_score: float
    ) -> list[str]:
