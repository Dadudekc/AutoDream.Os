...
class ValidationResult:
    ...
    def __init__(self, success: bool, message: str, details: Optional[Dict[str, Any]] = None) -> None:
        ...
        try:
            if self.file_path.exists():
                return ValidationResult(
                    ...
                    details={"file_path": str(self.file_path), "size": self.file_path.stat().st_size}
                )
            else:
                return ValidationResult(
                    success=False,
...
class FileSizeRule(ValidationRule):
    ...
    def __init__(self, file_path: Union[str, Path], max_size: int = 400) -> None:
        ...
        try:
            ...
            if line_count <= self.max_size:
                return ValidationResult(
                    ...
                    details={"file_path": str(self.file_path), "line_count": line_count, "max_size": self.max_size}
                )
            else:
                return ValidationResult(
                    success=False,
        ...
        try:
            ...
            if task_status == self.required_status:
                return ValidationResult(
                    ...
                    details={"task_id": task_id, "status": task_status, "required_status": self.required_status}
                )
            else:
                return ValidationResult(
                    success=False,
...
class SelfValidationProtocol:
    ...
    def validate_rule(self, rule_name: str, target: Any = None) -> Optional[ValidationResult]:
