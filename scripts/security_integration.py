...
class SecurityIntegration:
    ...
    def run_static_analysis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"✅ Static analysis completed: {result['results']['real_violations']} real violations")
            return check_result
...
def main():
    ...
    parser.add_argument("--check-only", action="store_true", help="Only run checks, don't generate reports")
