...
class CodeReviewExecutor:
    ...
    async def execute(self, operation: dict[str, Any]) -> dict[str, Any]:
        ...
        try:
            ...
            logger.info(
                f"{self.core.agent_id}: Code review completed - Quality score: {review_results['quality_score']}"
            )
    ...
    def get_status(self) -> dict[str, Any]:
        """Get executor status."""
        return {"executor_type": "code_review", "status": "ready", "last_execution": None}
