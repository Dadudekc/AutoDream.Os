#!/usr/bin/env python3
"""
🔄 UNIFIED DASHBOARD WRAPPER - Performance
======================================================

This file replaces the original performance_monitoring_dashboard.py with a wrapper
that uses the unified dashboard system.

Original file: /workspace/src/core/performance_monitoring_dashboard.py
Dashboard type: performance
Migration date: 2025-09-14T20:13:06.390366
...
def main():
    ...
    try:
        ...
        print(f"Error running performance dashboard: {e}")
        sys.exit(1)
