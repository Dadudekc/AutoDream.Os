...
def main():
    ...
    if args.test:
        ...
        for metric_type, threshold in manager.thresholds.items():
            print(f"  {metric_type}: {threshold.warning_threshold}{threshold.unit} (warning) / {threshold.critical_threshold}{threshold.unit} (critical)")
        ...
        for metric, details in summary.items():
            print(f"  {metric}: {details['warning']}{details['unit']} / {details['critical']}{details['unit']}")
