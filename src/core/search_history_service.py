...
class SearchHistoryService:
    ...
    def add_search(self, agent_id: str, query: str, enhanced_query: str,
    ...
    def get_search_suggestions(self, agent_id: str, partial_query: str,
        ...
        common_patterns = [
            "how to", "examples", "troubleshooting",
