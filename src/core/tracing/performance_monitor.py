...
class PerformanceMonitor:
    ...
    def _collect_system_metrics(self) -> None:
        ...
        try:
            ...
            self._create_metric("system.disk_usage_percent", disk_usage_percent, MetricType.GAUGE, "%")
            self._create_metric("system.active_connections", connections, MetricType.GAUGE, "count")
            
        except Exception as e:
            self.logger.error(f"Error collecting system metrics: {e}")
    
    def _create_metric(self, name: str, value: float, metric_type: MetricType,
    ...
    def record_timing(self, operation_name: str, duration: float, tags: Dict[str, str] = None) -> None:
