...
class TestEngineConfig(unittest.TestCase):
    ...
    def test_default_config(self):
        ...
        config = EngineConfig(
            engine_type=EngineType.PYGAME, platform=PlatformType.WINDOWS
        )
...
class TestPygameEngineInterface(unittest.TestCase):
    ...
    def test_create_window_success(
        self, mock_clock, mock_caption, mock_display, mock_mixer, mock_init
    ):
...
class TestGameEngineFactory(unittest.TestCase):
    ...
    def test_create_unity_engine(self):
        ...
        config = EngineConfig(
            engine_type=EngineType.UNITY, platform=PlatformType.WINDOWS
        )
    ...
    def test_create_unreal_engine(self):
        ...
        config = EngineConfig(
            engine_type=EngineType.UNREAL, platform=PlatformType.WINDOWS
        )
    ...
    def test_create_godot_engine(self):
        ...
        config = EngineConfig(
            engine_type=EngineType.GODOT, platform=PlatformType.WINDOWS
        )
    ...
    def test_create_unknown_engine(self):
        ...
        config = EngineConfig(
            engine_type=EngineType.CUSTOM, platform=PlatformType.WINDOWS
        )
