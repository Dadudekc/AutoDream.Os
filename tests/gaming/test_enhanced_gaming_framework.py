...
from enhanced_gaming_framework import (
    EnhancedGamingFramework, GameConfig, GameState, AIGameMode,
    PerformanceMetrics, AIGameObject, GameAutomationEngine, AIGameCoordinator
)
...
class TestAIGameObject(unittest.TestCase):
    ...
    def test_custom_game_object(self):
        ...
        obj = AIGameObject(
            "custom_id", "Custom Object", (200, 200),
            velocity=(1.0, 2.0),
            health=75.0,
            max_health=150.0,
...
class TestEnhancedGamingFramework(unittest.TestCase):
    ...
    def test_handle_events_quit(self):
        ...
        with patch('enhanced_gaming_framework.pygame.event.get', return_value=[mock_event]):
