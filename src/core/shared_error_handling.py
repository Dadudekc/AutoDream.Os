...
class SharedErrorHandler:
    ...
    def handle_file_operation_error(
        error: Exception, operation: str, file_path: str, context: dict[str, Any] | None = None
    ) -> None:
    ...
    def handle_validation_error(
        error: Exception, field_name: str, value: Any, context: dict[str, Any] | None = None
    ) -> None:
...
def handle_async_error(
    error: Exception, context: str, additional_info: dict[str, Any] | None = None
) -> None:
...
def log_and_continue(
    error: Exception, context: str, continue_message: str = "Continuing execution..."
) -> None:
...
def log_and_raise(error: Exception, context: str, custom_message: str | None = None) -> None:
