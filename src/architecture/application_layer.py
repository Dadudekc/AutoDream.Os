...
from .design_patterns_v2 import CommandInvoker, ServiceLocator
from .repository_layer import MessageEntity, RepositoryManager, TaskEntity
...
class GetSystemStatusUseCase(UseCase):
    ...
    def execute(self) -> UseCaseResult:
        ...
        try:
            ...
            system_status = {
                "services": {"statuses": service_statuses, "health": service_health},
                "repositories": {
...
class ApplicationService:
    ...
    def create_task(
        ...
        return self.execute_use_case(
            "create_task", title, description, assigned_agent, priority, due_date
        )
...
class ApplicationFacade:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            from .service_layer import DiscordService, MessagingService, ServiceConfig, TheaService
    ...
    def get_health_status(self) -> dict[str, Any]:
        ...
        return (
            system_status_result.to_dict()
            if system_status_result.success
            else {"error": system_status_result.error}
        )
