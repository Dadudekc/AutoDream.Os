...
class OnboardingService:
    ...
    def onboard_agent(self, agent_id: str, agent_data: Dict[str, Any]) -> Tuple[bool, Dict[str, Any]]:
        """Onboard a new agent."""
        try:
            # Validate agent data
    ...
    def _configure_agent_permissions(self, agent_id: str, capabilities: List[str]) -> Dict[str, Any]:
