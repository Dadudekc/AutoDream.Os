...
# Import the service
from src.services.architectural_principles import Architectural_PrinciplesService

# Initialize service
service = Architectural_PrinciplesService()
...
container = Container()
service = container.get(Architectural_PrinciplesService)
