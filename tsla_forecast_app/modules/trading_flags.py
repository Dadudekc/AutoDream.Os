...
class TradingFlagEngine:
    ...
    def generate_agent_flag(
        self, agent_id: AgentFlag, market_analysis: MarketAnalysis
    ) -> TradingFlag:
    ...
    def _determine_flag_type(
        self, agent_prefs: dict[str, Any], market_analysis: MarketAnalysis
    ) -> FlagType:
    ...
    def _calculate_price_target(
        self, market_analysis: MarketAnalysis, flag_type: FlagType
    ) -> float:
    ...
    def _generate_reasoning(
        self, agent_prefs: dict[str, Any], market_analysis: MarketAnalysis, flag_type: FlagType
    ) -> str:
