...
class ProjectRegistryManager:
    ...
    def __init__(self, registry_path: str = "/workspace/project_registry.json"):
    ...
    def register_component(self, name: str, path: str, purpose: str, 
                          owner: str, dependencies: List[str] = None) -> Component:
    ...
    def get_registry_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'component_breakdown': {
                'by_owner': {
                    agent: len(self.get_agent_components(agent)) 
...
def register_component(name: str, path: str, purpose: str, owner: str, 
                      dependencies: List[str] = None) -> Component:
