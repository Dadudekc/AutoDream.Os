...
class CompleteInfrastructureIntegration:
    ...
    def start_integration(self) -> None:
        ...
        if self.auto_integration:
            self._integration_thread = threading.Thread(target=self._integration_loop, daemon=True, daemon=True, daemon=True, daemon=True, daemon=True, daemon=True, daemon=True)
