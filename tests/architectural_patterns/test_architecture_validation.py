...
class TestArchitectureValidationComprehensive:
    ...
    def test_module_structure_validation(self):
        ...
        try:
            ...
            assert class_name.endswith('Service'), "Service classes should follow naming conventions"
    ...
    def test_security_validation(self):
        ...
        try:
            ...
            for method in sensitive_methods:
                assert method not in methods, f"Service should not expose sensitive method: {method}"
    ...
    def test_maintainability_validation(self):
        ...
        try:
            ...
            for method in methods:
                ...
                assert method.islower() or '_' in method, f"Method names should follow conventions: {method}"
            ...
            for method in methods:
                if hasattr(service, method):
                    ...
                    if callable(method_obj):
                        ...
                        if doc:
                            assert len(doc.strip()) > 5, f"Method {method} should have meaningful documentation"
    ...
    def test_architecture_quality_metrics(self):
        ...
        try:
            ...
            messaging_related = [m for m in methods if 'message' in m.lower() or 'send' in m.lower() or 'get' in m.lower()]
            cohesion_ratio = len(messaging_related) / len(methods) if methods else 0
            assert cohesion_ratio > 0.5, f"Service should have high cohesion, got {cohesion_ratio:.2f}"
