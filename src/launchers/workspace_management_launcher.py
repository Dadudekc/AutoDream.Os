...
try:
    from core.workspace_architecture_manager import WorkspaceArchitectureManager, WorkspaceType
    from core.workspace_security_manager import WorkspaceSecurityManager, SecurityLevel, Permission
    IMPORT_SUCCESS = True
    ...
    def list_all_workspaces(self) -> dict:
        ...
        try:
            ...
            return {
                ...
                "total_count": len(workspace_info)
            }
    ...
    def run_system_test(self) -> dict:
        ...
        try:
            ...
            try:
                ...
                test_results["workspace_creation"] = "PASSED" if ws_created else "FAILED"
                
                # Cleanup test workspace
                if ws_created:
                    test_path = Path(self.architecture_manager.base_workspace_dir) / test_ws
                    if test_path.exists():
                        import shutil
            ...
            return {
                ...
                "overall_status": "PASSED" if all("PASSED" in str(v) for v in test_results.values()) else "FAILED"
            }
...
def main():
    ...
    parser.add_argument("--create", nargs=2, metavar=("NAME", "AGENT"), help="Create secure workspace")
    ...
    if args.status:
        ...
        if "error" in result:
            ...
            for ws in result["workspaces"]:
                ...
                print(f"  {status_emoji} {ws['name']}: {ws['type']} ({ws['size_mb']} MB) {security_emoji}")
