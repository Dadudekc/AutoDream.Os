...
class CoreInterfaceService:
    ...
    def __init__(self, repository: Optional[IInterfaceRepository] = None) -> None:
        self._repository = repository or InMemoryInterfaceRepository()
        self._factory = CoreInterfaceFactory()
    
    def create_interface(self, interface_name: str, interface_id: str, **kwargs) -> Optional[Any]:
    ...
    def create_interface_with_builder(self, interface_name: str, interface_id: str, 
        ...
        try:
            ...
            if self._repository.save_interface(interface_id, interface):
                ...
                logger.error(f"Failed to store builder-created interface: {interface_name} ({interface_id})")
                return None
