...
class TestCoreComponentsSmoke:
    ...
    def test_core_directory_structure(self, test_config: TestConfig):
        ...
        for file_name in required_files:
            assert (core_dir / file_name).exists(), f"Required file {file_name} missing in core"
    ...
    def test_core_components_loc_compliance(self, test_config: TestConfig):
        ...
        for py_file in core_dir.glob("*.py"):
            ...
            with open(py_file, 'r', encoding='utf-8') as f:
                ...
                assert len(code_lines) <= test_config.MAX_LOC_CORE, \
    ...
    def test_core_components_oop_compliance(self, test_config: TestConfig):
        ...
        for py_file in core_dir.glob("*.py"):
            ...
            with open(py_file, 'r', encoding='utf-8') as f:
                ...
                assert 'class ' in content, f"Core component {py_file.name} must contain class definitions"
                ...
                assert functions_outside_classes <= 2, \
    ...
    def test_core_components_cli_interface(self, test_config: TestConfig):
        ...
        for py_file in core_dir.glob("*.py"):
            ...
            with open(py_file, 'r', encoding='utf-8') as f:
                ...
                assert 'argparse' in content, f"Core component {py_file.name} must use argparse for CLI"
                ...
                assert 'help=' in content, f"Core component {py_file.name} must have help documentation"
            ...
            with open(py_file, 'r', encoding='utf-8') as f:
                ...
                for import_line in import_lines:
                    ...
                    with open(py_file, 'r', encoding='utf-8') as f2:
                        ...
                        if not any(usage in content for usage in [module, module.split('.')[-1]]):
...
class TestCoreComponentsFunctionality:
    ...
    def test_core_components_executable(self, test_config: TestConfig):
        ...
        for py_file in core_dir.glob("*.py"):
            ...
            try:
                result = subprocess.run([sys.executable, str(py_file), "--help"], 
    ...
    def test_core_components_smoke_tests(self, test_config: TestConfig):
        ...
        for py_file in core_dir.glob("*.py"):
            ...
            try:
                result = subprocess.run([sys.executable, str(py_file), "--test"], 
                                     capture_output=True, text=True, timeout=10)
                ...
                if result.returncode == 0:
                    assert "test" in result.stdout.lower() or "smoke" in result.stdout.lower(), \
                        f"Core component {py_file.name} should provide test output"
                        
            except subprocess.TimeoutExpired:
                pytest.fail(f"Core component {py_file.name} timed out during smoke test")
            except Exception as e:
                ...
                if 'class ' in content:
                    ...
                    for class_line in class_lines:
                        ...
                        if class_start != -1:
                            ...
                            assert '"""' in class_content[:200] or "'''" in class_content[:200], \
