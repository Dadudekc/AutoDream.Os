...
class DistributedTracingSystem:
    ...
    def _initialize_tracing(self):
        ...
        try:
            ...
            self.tracer_provider = TracerProvider(
                resource=resource, sampler=trace.sampling.TraceIdRatioBased(self.config.sample_rate)
            )
    ...
    def start_span(
        ...
        if self.is_initialized and self.tracer:
            ...
            with self.tracer.start_as_current_span(
                name, context=parent_span, attributes=attributes or {}
            ) as span:
                yield span
        else:
    ...
    def set_span_status(self, span: Any, status: str, description: str | None = None):
    ...
    def trace_agent_operation(
        self, agent_id: str, operation: str, attributes: dict[str, Any] | None = None
    ):
        """
    ...
    def export_traces(self, output_file: str | None = None) -> str:
...
def create_tracing_system(config: TraceConfig | None = None) -> DistributedTracingSystem:
