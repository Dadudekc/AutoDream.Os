...
class SwarmAgentManager:
    ...
    def _get_agent_capabilities(self, agent_id: str, specialty: str) -> Set[str]:
        ...
        specialty_capabilities = {
            "Integration & Core Systems Specialist": {"integration", "core_systems", "system_architecture"},
            "Architecture & Design Specialist": {"architecture", "design_patterns", "system_design"},
            "Infrastructure & DevOps Specialist": {"infrastructure", "devops", "deployment", "monitoring"},
            "Quality Assurance Specialist (CAPTAIN)": {"quality_assurance", "testing", "validation", "oversight"},
            "Business Intelligence Specialist": {"analytics", "data_processing", "reporting", "metrics"},
            ...
            "Strategic Oversight & Final Approval": {"strategic_oversight", "final_approval", "decision_making"}
        }
    ...
    def get_agent_summary(self) -> Dict[str, any]:
        ...
        return {
            ...
            "agents_by_status": {
                ...
                for status in SwarmAgentStatus
            },
