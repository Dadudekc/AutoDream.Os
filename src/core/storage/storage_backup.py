...
class StorageBackupManager:
    ...
    def restore_backup(self, backup_name: str, restore_path: Path) -> bool:
        ...
        try:
            ...
            self.logger.info(f"Backup restored successfully: {backup_name} -> {restore_path}")
            return True
    ...
    def delete_backup(self, backup_name: str) -> bool:
        ...
        try:
            ...
            # Remove from history
            self.backup_history = [b for b in self.backup_history if b["backup_name"] != backup_name]
            self._save_backup_history()
    ...
    def cleanup_old_backups(self) -> int:
        ...
        try:
            ...
            old_backups = [b for b in self.backup_history if b["timestamp"] < cutoff_time]
