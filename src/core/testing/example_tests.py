...
class ExampleSecurityTest(BaseTest):
    ...
    def test_logic(self) -> bool:
        ...
        return authentication_working and authorization_working and input_validation_working
...
def run_example_tests():
    ...
    if results:
        ...
        for result in results:
            ...
            print(f"  {status_emoji} {result.test_name}: {result.status.value} ({result.execution_time:.3f}s)")
