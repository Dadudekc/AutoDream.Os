...
class MetricsManager:
    ...
    def __init__(self, metrics_file: str = "refactoring_metrics.json"):
        self.metrics_file = get_unified_utility().Path(metrics_file)
    ...
    def save_metrics(self) -> None:
        ...
        metrics_data = {
            ...
            "v2_compliance_violations_fixed": (
                self.current_metrics.v2_compliance_violations_fixed
            ),
            "lines_of_code_reduced": self.current_metrics.lines_of_code_reduced,
            "architecture_patterns_improved": (
                self.current_metrics.architecture_patterns_improved
            ),
        ...
        with open(self.metrics_file, "w") as f:
            write_json(metrics_data, f, indent=2)
