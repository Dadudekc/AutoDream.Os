...
from .project_registry import registry_manager, register_component, check_component_exists
from .design_authority import design_authority, review_component_plan
from .vibe_check import vibe_check_file, vibe_check_directory, vibe_check_strict
from .pr_review_protocol import pr_review_protocol, create_pull_request, CodeChange
...
Examples:
  ...
  python -m src.core.coherent_collaboration_cli pr pending --reviewer Agent-5
    ...
    check_comp_parser = registry_subparsers.add_parser('check-component', help='Check if component exists')
    check_comp_parser.add_argument('component_name', help='Name of component to check')
    
    # Registry: register component
    register_comp_parser = registry_subparsers.add_parser('register-component', help='Register new component')
    ...
    # Vibe: check strict
    check_strict_parser = vibe_subparsers.add_parser('check-strict', help='Strict check (fails on warnings)')
    ...
    create_pr_parser.add_argument('--priority', choices=['low', 'normal', 'high', 'urgent'], 
                                 default='normal', help='Review priority')
