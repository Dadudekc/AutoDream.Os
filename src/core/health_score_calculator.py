...
class HealthScoreCalculator:
    ...
    def calculate_metric_score(self, value: float, warning_threshold: float, 
        ...
        if value <= warning_threshold:
            ...
            return max(0.0, 75.0 - ((value - critical_threshold) / critical_threshold) * 75.0)
    ...
    def get_score_breakdown(self, snapshot: Any, thresholds: Dict[str, Any]) -> Dict[str, Any]:
...
def main():
    ...
    if args.test:
        ...
        for value in test_values:
            score = calculator.calculate_metric_score(value, warning_threshold, critical_threshold)
