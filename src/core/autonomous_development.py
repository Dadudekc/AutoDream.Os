...
class IntelligentPromptGenerator:
    ...
    def __init__(self):
        ...
        self.agent_specializations = {
            "code_reviewer": {
                ...
                "focus_areas": ["code quality", "maintainability", "performance", "security", "readability"]
            },
            "documentation_expert": {
                ...
                "focus_areas": ["clarity", "completeness", "examples", "structure", "accessibility"]
            },
            "testing_specialist": {
                ...
                "focus_areas": ["unit tests", "integration tests", "edge cases", "performance tests", "security tests"]
            },
            "performance_analyst": {
                ...
                "focus_areas": ["execution speed", "memory usage", "scalability", "resource efficiency", "algorithm optimization"]
            },
            "security_expert": {
                ...
                "focus_areas": ["input validation", "authentication", "authorization", "data protection", "secure communication"]
            }
        }
        
    def generate_intelligent_prompt(self, improvement: CodeImprovement, context: Dict[str, Any]) -> CursorAgentPrompt:
        ...
        confidence = self._calculate_confidence(improvement, context_analysis, agent_type)
    ...
    def _generate_context_summary(self, context: Dict[str, Any]) -> str:
        ...
        if context.get("recent_changes"):
            summary += f", recently modified with {len(context['recent_changes'])} changes"
            
        return summary
        
    def _select_focus_area(self, improvement: CodeImprovement, agent_info: Dict[str, Any]) -> str:
    ...
    def _create_intelligent_prompt(self, agent_info: Dict[str, Any], improvement: CodeImprovement, 
                                 context_analysis: Dict[str, Any], focus_area: str) -> str:
    ...
    def _define_expected_outcome(self, improvement: CodeImprovement, agent_type: str) -> str:
        ...
        return outcomes.get(agent_type, "General improvement in code quality and functionality")
        
    def _calculate_confidence(self, improvement: CodeImprovement, context_analysis: Dict[str, Any], 
...
class AutonomousDevelopmentEngine:
    ...
    def __init__(self):
        ...
        if not PYAUTOGUI_AVAILABLE:
            self.logger.error("PyAutoGUI not available - autonomous development disabled")
            return
    ...
    def _setup_autonomous_triggers(self):
        ...
        self.perpetual_motion.register_agent_activation("autonomous_code_review", self.autonomous_code_review)
        self.perpetual_motion.register_agent_activation("autonomous_documentation", self.autonomous_documentation)
        self.perpetual_motion.register_agent_activation("autonomous_testing", self.autonomous_testing)
        self.perpetual_motion.register_agent_activation("autonomous_optimization", self.autonomous_optimization)
        
    def start_autonomous_development(self):
        """Start autonomous development mode"""
        if not PYAUTOGUI_AVAILABLE:
            self.logger.error("Cannot start autonomous development - PyAutoGUI not available")
            return False
        ...
        self.logger.info("   Now using Cursor agents for intelligent prompt generation!")
        ...
        self.autonomous_thread = threading.Thread(
            target=self._autonomous_development_loop,
            daemon=True
        )
    ...
    def _create_intelligent_development_action(self, improvement: CodeImprovement, message: Dict[str, Any]):
        ...
        cursor_agent_prompt = self.prompt_generator.generate_intelligent_prompt(improvement, context)
    ...
    def _extract_development_context(self, message: Dict[str, Any], improvement: CodeImprovement) -> Dict[str, Any]:
    ...
    def _execute_development_actions(self):
        ...
        try:
            self.logger.info(f"Executing intelligent development action: {action.action_id}")
    ...
    def _execute_intelligent_code_generation_action(self, action: DevelopmentAction):
        ...
        try:
            ...
            self.logger.info(f"Generated intelligent conversation using {cursor_agent_prompt.agent_type}")
            self.logger.info(f"   Prompt: {prompt[:100]}...")
            self.logger.info(f"   Expected outcome: {cursor_agent_prompt.expected_outcome}")
    ...
    def _generate_intelligent_conversation(self):
        ...
        try:
            ...
            context = {
                ...
                "recent_changes": ["added Cursor agent integration", "enhanced prompt generation"]
            }
            ...
            self.development_actions.append(action)
            self.logger.info(f"Generated intelligent conversation using {cursor_agent_prompt.agent_type}")
            self.logger.info(f"   Prompt: {cursor_agent_prompt.intelligent_prompt[:100]}...")
...
def main():
    ...
    print("🚀 ENHANCED AUTONOMOUS DEVELOPMENT SYSTEM - CURSOR AGENTS GENERATE INTELLIGENT PROMPTS!")
    print("=" * 80)
    ...
    if engine.start_autonomous_development():
        ...
        try:
            ...
            while time.time() - start_time < 30:
                ...
                print(f"\r   🔄 Cycles: {stats['autonomous_cycle_count']} | "
                      f"💬 Conversations: {stats['active_conversations']} | "
                      f"🎯 Actions: {stats['pending_actions']} | "
                      f"🤖 Intelligent Agents: {stats['intelligent_agents']}", end="")
        ...
        print("   Now using Cursor agents for intelligent, context-aware development prompts!")
