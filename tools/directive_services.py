...
from directive_models import Directive, Initiative, DirectiveType, InitiativeStatus
            ...
            if Path(self.initiatives_file).exists():
                with open(self.initiatives_file, 'r') as f:
                    ...
                    for name, initiative_data in data.items():
                        ...
                        initiative.created_at = datetime.fromisoformat(initiative_data['created_at'])
                        initiative.updated_at = datetime.fromisoformat(initiative_data['updated_at'])
