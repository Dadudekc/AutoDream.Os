...
def test_coordinate_loader_integration(tmp_path: Path):
    ...
    from src.services.consolidated_messaging_service_new import ConsolidatedMessagingService
...
def test_legacy_compatibility(tmp_path: Path):
    ...
    from src.core.coordinate_loader import load_coordinates_from_json, get_agent_coordinates
