#!/usr/bin/env python3
"""
Inbox Core - Agent Cellphone V2
===============================

Core inbox functionality for message routing and storage.
...
from .inbox_types import Message, MessagePriority, MessageStatus, InboxStatus, SystemStatus
...
class InboxManager:
    ...
    def get_inbox_status(self, agent_id: str) -> InboxStatus:
        ...
        try:
            ...
            return InboxStatus(agent_id=agent_id, total_messages=0, status_counts={}, 
                             priority_counts={}, unread_count=0, urgent_count=0)
    ...
    def get_system_status(self) -> SystemStatus:
        ...
        try:
            ...
            return SystemStatus(status="error", total_messages=0, pending_messages=0, 
                              urgent_messages=0, active_agents=0)
