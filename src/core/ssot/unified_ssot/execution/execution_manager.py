...
from ..models import SSOTIntegrationResult
...
try:
    ...
    def get_performance_metrics(self) -> dict[str, Any]:
        ...
        execution_times = [
            r.execution_time for r in self.execution_history if r.execution_time is not None
        ]
    ...
    def get_execution_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "last_execution": (
                self.execution_history[-1].created_at.isoformat()
