...
class CoreAgentManagementIntegrationDemo:
    ...
    def __init__(self):
        ...
        self.registration_manager = AgentRegistrationManager(self.agent_manager, self.config_manager)
        ...
        self.performance_tracker = PerformanceTracker(self.agent_manager, self.config_manager)
    ...
    def _test_contract_performance_integration(self):
        ...
        assert "total_metrics" in performance_summary, "Performance summary missing total_metrics"
        print(f"    ✅ Performance tracking active: {performance_summary['tracking_active']}")
        
        # Get agent performance
        agent_performance = self.performance_tracker.get_agent_performance("test_agent_001")
        assert "agent_id" in agent_performance, "Agent performance data missing"
        print(f"    ✅ Agent performance data collected: {agent_performance['metrics']} metrics")
    ...
    def _test_cross_module_data_flow(self):
        ...
        print(f"    ✅ Second agent performance tracked: {agent_performance_2['metrics']} metrics")
        ...
        print(f"    ✅ Contract summary shows {contract_summary['total_contracts']} total contracts")
    ...
    def _test_error_handling(self):
        ...
        try:
            invalid_performance = self.performance_tracker.get_agent_performance("invalid_agent")
            assert "error" in invalid_performance, "Should return error for invalid agent"
        ...
        try:
            invalid_status = self.contract_manager.get_contract_status("invalid_contract")
        ...
        try:
            # Set agent offline
            self.agent_manager.update_agent_status("test_agent_001", AgentStatus.OFFLINE)
