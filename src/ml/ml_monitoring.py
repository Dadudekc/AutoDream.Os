...
class MLMonitoring:
    ...
    def record_prediction_metrics(self, model_name: str, version: str, predictions: List[float], actuals: List[float]):
        """Record prediction-related metrics."""
        return self.core.record_prediction_metrics(model_name, version, predictions, actuals)
    
    def record_training_metrics(self, model_name: str, version: str, loss: float, accuracy: float, epoch: int):
        """Record training metrics."""
        return self.core.record_training_metrics(model_name, version, loss, accuracy, epoch)
    
    def record_data_drift_metrics(self, model_name: str, version: str, drift_score: float, feature_name: str):
