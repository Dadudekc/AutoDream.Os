...
3. Message Captain: "Onboarding: Agent-1 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-2 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-3 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-5 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-6 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-7 ready for condition:  # TODO: Fix condition
        else:
...
2. Update status file with role information
3. Message Captain: "Onboarding: Agent-8 ready for condition:  # TODO: Fix condition
        else:
