...
class SystemHealthAssessor:
    ...
    def _calculate_health_score(self, metrics: List[PerformanceMetrics]) -> float:
        ...
        memory_score = self._calculate_metric_health_score(memory_values, self.health_thresholds["memory"])
        ...
        disk_score = self._calculate_metric_health_score(disk_values, self.health_thresholds["disk"])
