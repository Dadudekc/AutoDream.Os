...
class ErrorInfo:
    ...
    def __init__(self, error_id: str, error_type: str, severity: str,
        status: str, message: str, source: str):
...
class ErrorContext:
    ...
    def __init__(self, context_id: str, error_id: str, variables: Dict[str,
        Any]):
