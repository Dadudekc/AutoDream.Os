"""
Basic unit tests for src.core.backup_disaster_recovery.backup_cli
...
try:
    from src.core.backup_disaster_recovery.backup_cli import Backup_Cli
except ImportError:
    # If direct import fails, try from parent module
    from src.core.backup_disaster_recovery import Backup_Cli


class TestBackup_Cli:
    """Basic test suite for Backup_Cli."""

    def setup_method(self):
        """Set up test fixtures."""
        self.instance = Backup_Cli()

    def test_initialization(self):
        """Test that the component can be initialized."""
        assert self.instance is not None
        assert isinstance(self.instance, Backup_Cli)
