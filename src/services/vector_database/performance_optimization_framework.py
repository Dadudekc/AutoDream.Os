...
class ResourceOptimizer:
    ...
    def get_over_limit_resources(self) -> List[str]:
        ...
        return [resource for resource in self._resource_usage.keys()
...
class BottleneckAnalyzer:
    ...
    def identify_bottleneck(self, component: str, metric: str, value: float, threshold: float) -> None:
        ...
        with self._lock:
            ...
            logger.warning(f"Bottleneck identified: {component}.{metric} = {value} (threshold: {threshold})")
    
    def get_bottlenecks(self, component: Optional[str] = None) -> Dict[str, Dict[str, Any]]:
        """Get bottlenecks."""
        if component:
            return {component: self._bottlenecks.get(component, {})}
        return self._bottlenecks.copy()
    
    def clear_bottlenecks(self, component: Optional[str] = None) -> None:
        """Clear bottlenecks."""
        with self._lock:
            if component:
    ...
    def get_high_severity_bottlenecks(self) -> Dict[str, Dict[str, Any]]:
        ...
        for component, metrics in self._bottlenecks.items():
            high_metrics = {metric: data for metric, data in metrics.items() 
...
class OptimizationEngine:
    ...
    def run_optimization_cycle(self) -> Dict[str, Any]:
        ...
        metrics_needing_optimization = self._performance_optimizer.get_metrics_needing_optimization()
        ...
        logger.info(f"Optimization cycle completed: {len(results['performance_optimizations'])} performance, {len(results['resource_optimizations'])} resource optimizations")
        return results
