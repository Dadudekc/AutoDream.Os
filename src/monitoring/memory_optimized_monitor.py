...
class MemoryOptimizedMonitor:
    ...
    def __init__(self, project_root: Path, max_history: int = 100):
        ...
        # Alert thresholds
        self.alert_thresholds = {"cpu_percent": 80.0, "memory_mb": 1000.0, "error_rate": 0.1}
    ...
    async def monitoring_loop(self, interval: int = 60):
        ...
        while self.is_monitoring:
            try:
                ...
                logger.debug(
                    f"CPU: {snapshot.cpu_percent:.1f}%, Memory: {snapshot.memory_mb:.1f}MB"
                )
    ...
    def clear_old_data(self):
        ...
        with self.lock:
            ...
            logger.info("Cleared old data, freed memory")
...
_global_lightweight_monitor: MemoryOptimizedMonitor | None = None
