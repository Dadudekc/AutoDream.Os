...
from .refactor import format_refactor_report, generate_refactor_suggestions
...
Examples:
  ...
  python tools/analysis/cli.py --refactor --output refactor_plan.json
    ...
    parser.add_argument("--refactor", action="store_true", help="Generate refactoring suggestions")
    ...
    parser.add_argument(
        "--n", type=int, default=100000, help="Maximum number of files to analyze (default: 100000)"
    )
