...
from src.core.health_monitor import HealthMonitor, HealthStatus, AlertLevel, HealthMetric, HealthAlert
from src.core.performance_profiler import PerformanceProfiler, PerformanceLevel, PerformanceMetric, PerformanceSnapshot
from src.core.error_handler import ErrorHandler, CircuitBreaker, RetryStrategy, ErrorSeverity, ErrorInfo
from src.core.connection_pool_manager import ConnectionPoolManager, ConnectionPool, ConnectionState, ConnectionInfo
...
class TestHealthMonitor(unittest.TestCase):
    ...
    def test_component_registration(self):
        ...
        self.assertEqual(self.monitor.health_metrics["test_component"], mock_health_function)
...
class TestPerformanceProfiler(unittest.TestCase):
    ...
    def test_performance_alerts(self):
        ...
        self.profiler.set_performance_threshold("response_time", 1.0, PerformanceLevel.DEGRADED)
        self.profiler.set_performance_threshold("response_time", 2.0, PerformanceLevel.CRITICAL)
    ...
    def test_trend_analysis(self):
        ...
        for i in range(5):
            self.profiler.record_metric("test_operation", "response_time", 0.1 + i * 0.05)
            time.sleep(0.1)
        
        # Analyze trends
        trends = self.profiler.analyze_performance_trends("test_operation", "response_time")
...
class TestErrorHandler(unittest.TestCase):
    ...
    def test_circuit_breaker_state_transitions(self):
        ...
        circuit_breaker = self.error_handler.create_circuit_breaker("test_service", failure_threshold=2)
    ...
    def test_retry_strategy_execution(self):
        ...
        retry_strategy = self.error_handler.create_retry_strategy("test_operation", max_retries=2)
    ...
    def test_error_classification(self):
        ...
        validation_severity = self.error_handler._classify_error_severity(validation_error)
...
def run_core_infrastructure_tests():
    ...
    print("=" * 70)
    print("Focus: Health monitoring, performance profiling, error handling, connection pooling")
