...
class AgentIntegrationAssessment:
    ...
    def _get_agent_info(self, agent_id: str) -> Dict[str, Any]:
        ...
        if (
            "roles" in self.agent_configs
            and agent_id in self.agent_configs["roles"]["roles"]
        ):
    ...
    def _assess_integration_complexity(self, agent_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.warning(
                f"⚠️ Error assessing integration complexity for {agent_id}: {e}"
            )
    ...
    def _identify_dependencies(self, agent_id: str) -> List[str]:
        ...
        try:
            ...
            self.logger.warning(
                f"⚠️ Error identifying dependencies for {agent_id}: {e}"
            )
    ...
    def _generate_agent_recommendations(
        ...
        try:
            ...
            self.logger.warning(
                f"⚠️ Error generating recommendations for {agent_id}: {e}"
            )
