...
from src.core.testing.testing_core import TestExecutor, BaseTest
...
class TestSuiteManager:
    ...
    def create_test_suite(self, suite_id: str, suite_name: str, description: str = "") -> TestSuite:
...
class TestScheduler:
    ...
    def schedule_suite(self, suite: TestSuite, test_registry: Dict[str, BaseTest]) -> None:
...
class TestOrchestrator:
    ...
    def _initialize_default_suites(self) -> None:
        ...
        performance_suite.test_types = [TestType.PERFORMANCE, TestType.LOAD, TestType.STRESS]
    ...
    def get_test_summary(self) -> Dict[str, Any]:
        ...
        skipped = sum(1 for r in self.execution_history if r.status == TestStatus.SKIPPED)
